...
<?php
include_once("form_cg_company_reg_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_company_reg_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['recarga'];
}
?>
...
<?php
 include_once("form_cg_company_reg_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" enctype="multipart/form-data" 
               action="form_cg_company_reg_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_company_reg_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_company_reg_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gsjc_line" id="hidden_field_data_gsjc" style="<?php echo $sStyleHidden_gsjc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gsjc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gsjc_label"><span id="id_label_gsjc"><?php echo $this->nm_new_label['gsjc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['gsjc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['gsjc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tyshxydm_line" id="hidden_field_data_tyshxydm" style="<?php echo $sStyleHidden_tyshxydm; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tyshxydm_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tyshxydm_label"><span id="id_label_tyshxydm"><?php echo $this->nm_new_label['tyshxydm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['tyshxydm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['tyshxydm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qylx_line" id="hidden_field_data_qylx" style="<?php echo $sStyleHidden_qylx; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qylx_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qylx_label"><span id="id_label_qylx"><?php echo $this->nm_new_label['qylx']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['qylx']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['qylx'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zczb_line" id="hidden_field_data_zczb" style="<?php echo $sStyleHidden_zczb; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zczb_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_zczb_label"><span id="id_label_zczb"><?php echo $this->nm_new_label['zczb']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['zczb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['zczb'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clrq_line" id="hidden_field_data_clrq" style="<?php echo $sStyleHidden_clrq; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clrq_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clrq_label"><span id="id_label_clrq"><?php echo $this->nm_new_label['clrq']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['clrq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['clrq'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jyfw_line" id="hidden_field_data_jyfw" style="<?php echo $sStyleHidden_jyfw; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_jyfw_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_jyfw_label"><span id="id_label_jyfw"><?php echo $this->nm_new_label['jyfw']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['jyfw']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['jyfw'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_khyh_line" id="hidden_field_data_khyh" style="<?php echo $sStyleHidden_khyh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_khyh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_khyh_label"><span id="id_label_khyh"><?php echo $this->nm_new_label['khyh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['khyh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['khyh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_yhzh_line" id="hidden_field_data_yhzh" style="<?php echo $sStyleHidden_yhzh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_yhzh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_yhzh_label"><span id="id_label_yhzh"><?php echo $this->nm_new_label['yhzh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['yhzh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['php_cmp_required']['yhzh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_company_reg_mob");
 parent.scAjaxDetailHeight("form_cg_company_reg_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
