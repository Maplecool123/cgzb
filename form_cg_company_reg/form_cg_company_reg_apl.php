...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_gsmc)) 
          {
              $_SESSION['v_gsmc'] = $this->v_gsmc;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_cg_company_reg_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("zh_cn");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['initialize'])
          {
              $_SESSION['scriptcase']['form_cg_company_reg']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_cg_company_reg']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_cg_company_reg']['upload_field_info']['yyzzfile'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cg_company_reg',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cg_company_reg']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cg_company_reg'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_company_reg']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_company_reg']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_cg_company_reg') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_company_reg']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_company'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_cg_company_reg']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_cg_company_reg'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['table_refresh'] = false;
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_field_ul_name'][$this->yyzzfile_ul_name]))
          {
              $this->NM_ajax_info['param']['yyzzfile_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_field_ul_name'][$this->yyzzfile_ul_name];
          }
      ...
      elseif (isset($this->yyzzfile_ul_name) && '' != $this->yyzzfile_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_field_ul_name'][$this->yyzzfile_ul_name]))
          {
              $this->yyzzfile_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_field_ul_name'][$this->yyzzfile_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_company_reg']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_cg_company_reg/form_cg_company_reg_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_cg_company_reg_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_cg_company_reg_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_cg_company_reg_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_cg_company_reg/form_cg_company_reg_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_cg_company_reg_erro.class.php"); 
      }
      $this->Erro      = new form_cg_company_reg_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_company_reg']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_redir_atualiz'] == "ok")
          {
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_cg_company_reg', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_cg_company_reg', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_cg_company_reg']) || !is_array($this->NM_ajax_info['errList']['geral_form_cg_company_reg']))
              {
                  $this->NM_ajax_info['errList']['geral_form_cg_company_reg'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_cg_company_reg'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_gsmc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['gsmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['gsmc'] == "on")) 
      { 
          if ($this->gsmc == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['gsjc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['gsjc'] == "on")) 
      { 
          if ($this->gsjc == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['tyshxydm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['tyshxydm'] == "on")) 
      { 
          if ($this->tyshxydm == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->qylx == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['qylx']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['qylx'] == "on"))
      {
          ...
          if (!empty($this->qylx) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['Lookup_qylx']) && !in_array($this->qylx, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['Lookup_qylx']))
          {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['gsdz']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['gsdz'] == "on")) 
      { 
          if ($this->gsdz == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['fddbr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['fddbr'] == "on")) 
      { 
          if ($this->fddbr == "")  
          { 
    ...
    function ValidateField_zczb(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['zczb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['zczb'] == "on") 
           { 
    ...
    function ValidateField_clrq(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_clrq' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['clrq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['clrq'] == "on")) 
           { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['jyfw']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['jyfw'] == "on")) 
      { 
          if ($this->jyfw == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->khyh == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['khyh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['khyh'] == "on"))
      {
          ...
          if (!empty($this->khyh) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['Lookup_khyh']) && !in_array($this->khyh, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['Lookup_khyh']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['khyh']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['yhzh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['yhzh'] == "on")) 
      { 
          if ($this->yhzh == "")  
          { 
...
;
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['lxr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['lxr'] == "on")) 
      { 
          if ($this->lxr == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['lxrdh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['lxrdh'] == "on")) 
      { 
          if ($this->lxrdh == "")  
          { 
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['php_cmp_required']['email'] == "on") 
          { 
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_cg_company_reg_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_cg_company_reg_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_cg_company_reg_pack_protect_string('') => form_cg_company_reg_pack_protect_string('请选择'));
...
ORDER BY mc";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_cg_company_reg_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_cg_company_reg_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['qylx']['valList'][$i] = form_cg_company_reg_pack_protect_string($v);
          }
...
ORDER BY mc";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['khyh']['valList'][$i] = form_cg_company_reg_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] = '';
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->shyj = $this->shyj_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('gsmc', 'gsjc', 'tyshxydm', 'qylx', 'gsdz', 'fddbr', 'zczb', 'clrq', 'jyfw', 'khyh', 'yhdz', 'yhzh', 'lxr', 'lxrdh', 'fax', 'bgdh', 'email', 'bz'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['form_cg_company_reg']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['parms'] = "id?#?$this->id?@?"; 
      }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_filter_form'];
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['select'] = ""; 
              } 
          } 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sub_dir'][0]  = "yyzz";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_select'] = $this->nmgp_dados_select;
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_select'];
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
    ...
    include_once("form_cg_company_reg_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_cg_company_reg = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['total'] = $qt_geral_reg_form_cg_company_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_cg_company_reg_pack_ajax_response();
      ...
      $Nm_datas['clrq'] = "date";$Nm_datas['shsj'] = "datetime";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_cg_company_reg_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_cg_company_reg_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['masterValue']))
{
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_reg']['retorno_edit'] = "";
   }
