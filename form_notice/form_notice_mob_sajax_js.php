  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_notice_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate title
  function do_ajax_form_notice_mob_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_title(var_title, var_script_case_init, do_ajax_form_notice_mob_validate_title_cb);
  } // do_ajax_form_notice_mob_validate_title

  function do_ajax_form_notice_mob_validate_title_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_title_cb

  // ---------- Validate content
  function do_ajax_form_notice_mob_validate_content()
  {
    var nomeCampo_content = "content";
    var var_content = scAjaxGetFieldEditorHtml(nomeCampo_content);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_content(var_content, var_script_case_init, do_ajax_form_notice_mob_validate_content_cb);
  } // do_ajax_form_notice_mob_validate_content

  function do_ajax_form_notice_mob_validate_content_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "content";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_content_cb

  // ---------- Validate author
  function do_ajax_form_notice_mob_validate_author()
  {
    var nomeCampo_author = "author";
    var var_author = scAjaxGetFieldText(nomeCampo_author);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notice_mob_validate_author(var_author, var_script_case_init, do_ajax_form_notice_mob_validate_author_cb);
  } // do_ajax_form_notice_mob_validate_author

  function do_ajax_form_notice_mob_validate_author_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "author";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notice_mob_validate_author_cb
  // ---------- Form
  function do_ajax_form_notice_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_notice_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_notice_mob_submit_form(var_title, var_content, var_author, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_notice_mob_submit_form_cb);
  } // do_ajax_form_notice_mob_submit_form

  function do_ajax_form_notice_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_notice_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_notice_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_notice_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_notice_mob_navigate_form_cb);
  } // do_ajax_form_notice_mob_navigate_form

  function do_ajax_form_notice_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_notice_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_notice_mob_navigate_form_cb
  function sc_hide_form_notice_mob_form()
  {
