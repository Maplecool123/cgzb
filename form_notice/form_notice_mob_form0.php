...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_title_line" id="hidden_field_data_title" style="<?php echo $sStyleHidden_title; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_title_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_title_label"><span id="id_label_title"><?php echo $this->nm_new_label['title']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['php_cmp_required']['title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['php_cmp_required']['title'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_content_line" id="hidden_field_data_content" style="<?php echo $sStyleHidden_content; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_content_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_content_label"><span id="id_label_content"><?php echo $this->nm_new_label['content']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['php_cmp_required']['content']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['php_cmp_required']['content'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><span id="id_read_on_content" style="<?php echo $sStyleReadLab_content; ?>"><?php echo $this->content; ?></span><span id="id_read_off_content" style="<?php echo $sStyleReadInp_content; ?>"><textarea id="content" name="content" cols="100" rows="15" class="mceEditor_content" style="width: 100%; height:400px;"><?php echo $this->content; ?></textarea>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_author_line" id="hidden_field_data_author" style="<?php echo $sStyleHidden_author; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_author_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_author_label"><span id="id_label_author"><?php echo $this->nm_new_label['author']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['php_cmp_required']['author']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_notice_mob']['php_cmp_required']['author'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
