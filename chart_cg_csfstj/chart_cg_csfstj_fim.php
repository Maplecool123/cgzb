...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____chart_cg_csfstj"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____chart_cg_csfstj"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_cg_csfstj']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_cg_csfstj']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_cg_csfstj']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_cg_csfstj']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_cg_csfstj']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_cg_csfstj']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_cg_csfstj']['embutida_filho'] as $ind => $sc_init)
          {
