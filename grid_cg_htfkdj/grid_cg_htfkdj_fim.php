...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_htfkdj"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_htfkdj"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_htfkdj']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_htfkdj']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_htfkdj']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_htfkdj']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cg_htfkdj']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cg_htfkdj']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cg_htfkdj']['embutida_filho'] as $ind => $sc_init)
          {
