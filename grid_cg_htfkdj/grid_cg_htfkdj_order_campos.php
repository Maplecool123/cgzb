<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_htfkdj_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_htfkdj_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["htmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["htmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["htmc"] : "" . $this->Nm_lang['lang_cg_htfkdj_fld_htmc'] . "";
   $tab_ger_campos['htbh'] = "on";
   $tab_def_campos['htbh'] = "htbh";
   $tab_converte["htbh"]   = "htbh";
   $tab_labels["htbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["htbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["htbh"] : "" . $this->Nm_lang['lang_cg_htfkdj_fld_htbh'] . "";
   $tab_ger_campos['htje'] = "on";
   $tab_def_campos['htje'] = "htje";
   $tab_converte["htje"]   = "htje";
   $tab_labels["htje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["htje"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["htje"] : "" . $this->Nm_lang['lang_cg_htfkdj_fld_htje'] . "";
   $tab_ger_campos['fkje'] = "on";
   $tab_def_campos['fkje'] = "fkje";
   $tab_converte["fkje"]   = "fkje";
   $tab_labels["fkje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fkje"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fkje"] : "" . $this->Nm_lang['lang_cg_htfkdj_fld_fkje'] . "";
   $tab_ger_campos['fkzb'] = "on";
   $tab_def_campos['fkzb'] = "fkzb";
   $tab_converte["fkzb"]   = "fkzb";
   $tab_labels["fkzb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fkzb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fkzb"] : "" . $this->Nm_lang['lang_cg_htfkdj_fld_fkzb'] . "";
   $tab_ger_campos['fklx'] = "on";
   $tab_def_campos['fklx'] = "fklx";
   $tab_converte["fklx"]   = "fklx";
   $tab_labels["fklx"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fklx"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fklx"] : "" . $this->Nm_lang['lang_cg_htfkdj_fld_fklx'] . "";
   $tab_ger_campos['fkjd'] = "on";
   $tab_def_campos['fkjd'] = "fkjd";
   $tab_converte["fkjd"]   = "fkjd";
   $tab_labels["fkjd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fkjd"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fkjd"] : "" . $this->Nm_lang['lang_cg_htfkdj_fld_fkjd'] . "";
   $tab_ger_campos['fkdjrq'] = "on";
   $tab_def_campos['fkdjrq'] = "fkdjrq";
   $tab_converte["fkdjrq"]   = "fkdjrq";
   $tab_labels["fkdjrq"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fkdjrq"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['labels']["fkdjrq"] : "" . $this->Nm_lang['lang_cg_htfkdj_fld_fkdjrq'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_htfkdj'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_htfkdj_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_htfkdj']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
