...
class sec_grid_sec_users_xml
{
   ...
   //---- 
   function sec_grid_sec_users_xml()
   {
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->changepassword))
         {
             $this->changepassword = sc_convert_encoding($this->changepassword, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " changepassword =\"" . $this->trata_dados($this->changepassword) . "\"";
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?>-<?php echo $this->Ini->Nm_lang['lang_tbl_sec_users'] ?> :: XML</TITLE>
