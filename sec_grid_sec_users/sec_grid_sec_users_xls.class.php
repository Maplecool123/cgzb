...
class sec_grid_sec_users_xls
{
   ...
   var $Tit_doc;
   //---- 
   function sec_grid_sec_users_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "sec_grid_sec_users.xls";
   ...
   function grava_arquivo()
   {
      ...
      { 
          ...
          if ($Cada_col == "changepassword" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
   ...
   //----- changepassword
   function NM_export_changepassword()
   {
         if (!NM_is_utf8($this->changepassword))
         {
             $this->changepassword = sc_convert_encoding($this->changepassword, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->changepassword, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?>-<?php echo $this->Ini->Nm_lang['lang_tbl_sec_users'] ?> :: Excel</TITLE>
