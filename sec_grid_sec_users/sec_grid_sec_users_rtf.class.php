...
class sec_grid_sec_users_rtf
{
   ...
   //---- 
   function sec_grid_sec_users_rtf()
   {
   ...
   function NM_export_changepassword()
   {
         ...
         $this->changepassword = str_replace('<', '&lt;', $this->changepassword);
         $this->changepassword = str_replace('>', '&gt;', $this->changepassword);
         $this->Texto_tag .= "<td>" . $this->changepassword . "</td>\r\n";
   }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?>-<?php echo $this->Ini->Nm_lang['lang_tbl_sec_users'] ?> :: RTF</TITLE>
