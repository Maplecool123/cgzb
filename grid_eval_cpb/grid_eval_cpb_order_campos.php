<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_eval_cpb_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_eval_cpb_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['mc'] = "on";
   $tab_def_campos['mc'] = "mc";
   $tab_converte["mc"]   = "mc";
   $tab_labels["mc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["mc"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["mc"] : "" . $this->Nm_lang['lang_eval_cpb_fld_mc'] . "";
   $tab_ger_campos['sfzg'] = "on";
   $tab_def_campos['sfzg'] = "sfzg";
   $tab_converte["sfzg"]   = "sfzg";
   $tab_labels["sfzg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["sfzg"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["sfzg"] : "" . $this->Nm_lang['lang_eval_cpb_fld_sfzg'] . "";
   $tab_ger_campos['isdefault'] = "on";
   $tab_def_campos['isdefault'] = "isdefault";
   $tab_converte["isdefault"]   = "isdefault";
   $tab_labels["isdefault"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["isdefault"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["isdefault"] : "" . $this->Nm_lang['lang_eval_cpb_fld_isdefault'] . "";
   $tab_ger_campos['tjsj'] = "on";
   $tab_def_campos['tjsj'] = "tjsj";
   $tab_converte["tjsj"]   = "tjsj";
   $tab_labels["tjsj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["tjsj"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["tjsj"] : "" . $this->Nm_lang['lang_eval_cpb_fld_tjsj'] . "";
   $tab_ger_campos['cpbview'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cpbview'] = "cpbview";
       $tab_converte["cpbview"]   = "cpbview";
   }
   else
   {
       $tab_def_campos['cpbview'] = "";
       $tab_converte[""]   = "cpbview";
   }
   $tab_labels["cpbview"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["cpbview"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['labels']["cpbview"] : "操作";
   $tab_ger_campos['cpbview'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_eval_cpb'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_eval_cpb_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_eval_cpb']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
