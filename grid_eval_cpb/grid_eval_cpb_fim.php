...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_eval_cpb"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_eval_cpb"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_eval_cpb'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eval_cpb']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_eval_cpb']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eval_cpb']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_eval_cpb']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_eval_cpb']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_eval_cpb']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_eval_cpb']['embutida_filho'] as $ind => $sc_init)
          {
