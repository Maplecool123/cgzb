...
<?php
include_once("form_cg_xmzjk_auto_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_xmzjk_auto_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['recarga'];
}
?>
...
<?php
 include_once("form_cg_xmzjk_auto_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_xmzjk_auto'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_xmzjk_auto'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bincluir", "nm_atualiza ('incluir');", "nm_atualiza ('incluir');", "sc_b_ins_t", "", "生成专家库", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_t", "", "重新生成", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zbggbh_label" id="hidden_field_label_zbggbh" style="<?php echo $sStyleHidden_zbggbh; ?>"><span id="id_label_zbggbh"><?php echo $this->nm_new_label['zbggbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['zbggbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['zbggbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_zbggbh_line" id="hidden_field_data_zbggbh" style="<?php echo $sStyleHidden_zbggbh; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zbggbh_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_zbggbh" class="sc-ui-readonly-zbggbh css_zbggbh_line" style="<?php echo $sStyleReadLab_zbggbh; ?>"><?php echo $this->form_encode_input($this->zbggbh); ?></span><span id="id_read_off_zbggbh" style="white-space: nowrap;<?php echo $sStyleReadInp_zbggbh; ?>">
 ...
 size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['zbggbh']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['zbggbh']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_zbgg"]) && $this->Ini->sc_lig_md5["grid_cg_zbgg"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,zbggbh,id*scoutnm_evt_ret_busca*scinsc_form_cg_xmzjk_auto_zbggbh_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_xmzjk_auto@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,zbggbh,id*scoutnm_evt_ret_busca*scinsc_form_cg_xmzjk_auto_zbggbh_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgbbh_label" id="hidden_field_label_cgbbh" style="<?php echo $sStyleHidden_cgbbh; ?>"><span id="id_label_cgbbh"><?php echo $this->nm_new_label['cgbbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['cgbbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['cgbbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cgbbh_line" id="hidden_field_data_cgbbh" style="<?php echo $sStyleHidden_cgbbh; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgbbh_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="cgbbh" value="<?php echo $this->form_encode_input($cgbbh); ?>"><span id="id_ajax_label_cgbbh"><?php echo nl2br($cgbbh); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgbmc_label" id="hidden_field_label_cgbmc" style="<?php echo $sStyleHidden_cgbmc; ?>"><span id="id_label_cgbmc"><?php echo $this->nm_new_label['cgbmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['cgbmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['cgbmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cgbmc_line" id="hidden_field_data_cgbmc" style="<?php echo $sStyleHidden_cgbmc; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgbmc_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="cgbmc" value="<?php echo $this->form_encode_input($cgbmc); ?>"><span id="id_ajax_label_cgbmc"><?php echo nl2br($cgbmc); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zjrs_label" id="hidden_field_label_zjrs" style="<?php echo $sStyleHidden_zjrs; ?>"><span id="id_label_zjrs"><?php echo $this->nm_new_label['zjrs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['zjrs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['zjrs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_zjrs_line" id="hidden_field_data_zjrs" style="<?php echo $sStyleHidden_zjrs; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zjrs_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pc_label" id="hidden_field_label_pc" style="<?php echo $sStyleHidden_pc; ?>"><span id="id_label_pc"><?php echo $this->nm_new_label['pc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['pc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['php_cmp_required']['pc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pc_line" id="hidden_field_data_pc" style="<?php echo $sStyleHidden_pc; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pc_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="pc" value="<?php echo $this->form_encode_input($pc); ?>"><span id="id_ajax_label_pc"><?php echo nl2br($pc); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgfs_label" id="hidden_field_label_cgfs" style="<?php echo $sStyleHidden_cgfs; ?>"><span id="id_label_cgfs"><?php echo $this->nm_new_label['cgfs']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_isauto_label" id="hidden_field_label_isauto" style="<?php echo $sStyleHidden_isauto; ?>"><span id="id_label_isauto"><?php echo $this->nm_new_label['isauto']; ?></span></TD>
    <TD class="scFormDataOdd css_isauto_line" id="hidden_field_data_isauto" style="<?php echo $sStyleHidden_isauto; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isauto_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="isauto" value="<?php echo $this->form_encode_input($isauto); ?>"><span id="id_ajax_label_isauto"><?php echo nl2br($isauto); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zdrs_line" id="hidden_field_data_zdrs" style="<?php echo $sStyleHidden_zdrs; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zdrs_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="zdrs" value="<?php echo $this->form_encode_input($zdrs); ?>"><span id="id_ajax_label_zdrs"><?php echo nl2br($zdrs); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zsrs_line" id="hidden_field_data_zsrs" style="<?php echo $sStyleHidden_zsrs; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zsrs_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="zsrs" value="<?php echo $this->form_encode_input($zsrs); ?>"><span id="id_ajax_label_zsrs"><?php echo nl2br($zsrs); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xzcs_label" id="hidden_field_label_xzcs" style="<?php echo $sStyleHidden_xzcs; ?>"><span id="id_label_xzcs"><?php echo $this->nm_new_label['xzcs']; ?></span></TD>
    <TD class="scFormDataOdd css_xzcs_line" id="hidden_field_data_xzcs" style="<?php echo $sStyleHidden_xzcs; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xzcs_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="xzcs" value="<?php echo $this->form_encode_input($xzcs); ?>"><span id="id_ajax_label_xzcs"><?php echo nl2br($xzcs); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xmzjk_label" id="hidden_field_label_xmzjk" style="<?php echo $sStyleHidden_xmzjk; ?>"><span id="id_label_xmzjk"><?php echo $this->nm_new_label['xmzjk']; ?></span></TD>
    <TD class="scFormDataOdd css_xmzjk_line" id="hidden_field_data_xmzjk" style="<?php echo $sStyleHidden_xmzjk; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_xmzjk_line" style="vertical-align: top;padding: 0px">
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cg_xmzjk_auto_empty.htm' : $this->Ini->link_grid_cg_xmzjk_auto_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=350' . $parms_lig_cons;
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk_auto']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_xmzjk_auto");
 parent.scAjaxDetailHeight("form_cg_xmzjk_auto", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
