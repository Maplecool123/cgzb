  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sjplshlog_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate shzt
  function do_ajax_form_sjplshlog_mob_validate_shzt()
  {
    var nomeCampo_shzt = "shzt";
    var var_shzt = scAjaxGetFieldRadio(nomeCampo_shzt);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sjplshlog_mob_validate_shzt(var_shzt, var_script_case_init, do_ajax_form_sjplshlog_mob_validate_shzt_cb);
  } // do_ajax_form_sjplshlog_mob_validate_shzt

  function do_ajax_form_sjplshlog_mob_validate_shzt_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sjplshlog_mob_validate_shzt_cb

  // ---------- Validate shyj
  function do_ajax_form_sjplshlog_mob_validate_shyj()
  {
    var nomeCampo_shyj = "shyj";
    var var_shyj = scAjaxGetFieldText(nomeCampo_shyj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sjplshlog_mob_validate_shyj(var_shyj, var_script_case_init, do_ajax_form_sjplshlog_mob_validate_shyj_cb);
  } // do_ajax_form_sjplshlog_mob_validate_shyj

  function do_ajax_form_sjplshlog_mob_validate_shyj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "shyj";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sjplshlog_mob_validate_shyj_cb
  // ---------- Form
  function do_ajax_form_sjplshlog_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sjplshlog_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sjplshlog_mob_submit_form(var_shzt, var_shyj, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sjplshlog_mob_submit_form_cb);
  } // do_ajax_form_sjplshlog_mob_submit_form

  function do_ajax_form_sjplshlog_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sjplshlog_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_sjplshlog_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_sjplshlog_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sjplshlog_mob_navigate_form_cb);
  } // do_ajax_form_sjplshlog_mob_navigate_form

  function do_ajax_form_sjplshlog_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_sjplshlog_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_sjplshlog_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_sjplshlog_mob_navigate_form_cb
  function sc_hide_form_sjplshlog_mob_form()
  {
  ...
  var ajax_error_list = {
    "shzt": {"label": "<?php echo $this->Ini->Nm_lang['lang_sjplshlog_fld_shzt'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "shyj": {"label": "<?php echo $this->Ini->Nm_lang['lang_sjplshlog_fld_shyj'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
