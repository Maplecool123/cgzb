...
<?php
include_once("form_cg_cgjh_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_cgjh_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['recarga'];
}
?>
...
<?php
 include_once("form_cg_cgjh_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_cgjh'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_cgjh'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xmbh_label" id="hidden_field_label_xmbh" style="<?php echo $sStyleHidden_xmbh; ?>"><span id="id_label_xmbh"><?php echo $this->nm_new_label['xmbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['xmbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['xmbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xmmc_label" id="hidden_field_label_xmmc" style="<?php echo $sStyleHidden_xmmc; ?>"><span id="id_label_xmmc"><?php echo $this->nm_new_label['xmmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['xmmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['xmmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ysje_label" id="hidden_field_label_ysje" style="<?php echo $sStyleHidden_ysje; ?>"><span id="id_label_ysje"><?php echo $this->nm_new_label['ysje']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['ysje']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['ysje'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zjly_label" id="hidden_field_label_zjly" style="<?php echo $sStyleHidden_zjly; ?>"><span id="id_label_zjly"><?php echo $this->nm_new_label['zjly']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['zjly']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['zjly'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xmfzr_label" id="hidden_field_label_xmfzr" style="<?php echo $sStyleHidden_xmfzr; ?>"><span id="id_label_xmfzr"><?php echo $this->nm_new_label['xmfzr']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['xmfzr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['xmfzr'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sbbm_label" id="hidden_field_label_sbbm" style="<?php echo $sStyleHidden_sbbm; ?>"><span id="id_label_sbbm"><?php echo $this->nm_new_label['sbbm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['sbbm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['sbbm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sbrq_label" id="hidden_field_label_sbrq" style="<?php echo $sStyleHidden_sbrq; ?>"><span id="id_label_sbrq"><?php echo $this->nm_new_label['sbrq']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['sbrq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['sbrq'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sbr_label" id="hidden_field_label_sbr" style="<?php echo $sStyleHidden_sbr; ?>"><span id="id_label_sbr"><?php echo $this->nm_new_label['sbr']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['sbr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['php_cmp_required']['sbr'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgjh']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_cgjh");
 parent.scAjaxDetailHeight("form_cg_cgjh", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
