<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_zbgg_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_zbgg_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["id"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_id'] . "";
   $tab_ger_campos['cgbbh'] = "on";
   $tab_def_campos['cgbbh'] = "cgbbh";
   $tab_converte["cgbbh"]   = "cgbbh";
   $tab_labels["cgbbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["cgbbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["cgbbh"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_cgbbh'] . "";
   $tab_ger_campos['cgbmc'] = "on";
   $tab_def_campos['cgbmc'] = "cgbmc";
   $tab_converte["cgbmc"]   = "cgbmc";
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_cgbmc'] . "";
   $tab_ger_campos['bzj'] = "on";
   $tab_def_campos['bzj'] = "bzj";
   $tab_converte["bzj"]   = "bzj";
   $tab_labels["bzj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["bzj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["bzj"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_bzj'] . "";
   $tab_ger_campos['bsf'] = "on";
   $tab_def_campos['bsf'] = "bsf";
   $tab_converte["bsf"]   = "bsf";
   $tab_labels["bsf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["bsf"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["bsf"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_bsf'] . "";
   $tab_ger_campos['zbkssj'] = "on";
   $tab_def_campos['zbkssj'] = "zbkssj";
   $tab_converte["zbkssj"]   = "zbkssj";
   $tab_labels["zbkssj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["zbkssj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["zbkssj"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_zbkssj'] . "";
   $tab_ger_campos['shzt'] = "on";
   $tab_def_campos['shzt'] = "shzt";
   $tab_converte["shzt"]   = "shzt";
   $tab_labels["shzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["shzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["shzt"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_shzt'] . "";
   ...
   $tab_labels["splc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["splc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["splc"] : "操作";
   ...
   $tab_labels["splcxx"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["splcxx"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['labels']["splcxx"] : "审批信息";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_zbgg'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_zbgg_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
