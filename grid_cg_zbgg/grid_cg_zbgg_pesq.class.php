...
class grid_cg_zbgg_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_zbgg_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_zbgg_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_zbgg_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_zbgg'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_zbgg/grid_cg_zbgg_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_zbgg_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_zbgg_ajax.js"></script>
 <script type="text/javascript">
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_zbgg'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cgbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgbbh']; 
          $cgbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgbbh_cond']; 
          $cgbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgbmc']; 
          $cgbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgbmc_cond']; 
          $cgfs = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgfs']; 
          $cgfs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgfs_cond']; 
          $shzt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['shzt']; 
          $shzt_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['shzt_cond']; 
          $zbkssj_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_dia']; 
          $zbkssj_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_mes']; 
          $zbkssj_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_ano']; 
          $zbkssj_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_dia']; 
          $zbkssj_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_mes']; 
          $zbkssj_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_ano']; 
          $zbkssj_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_hor']; 
          $zbkssj_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_min']; 
          $zbkssj_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_seg']; 
          $zbkssj_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_hor']; 
          $zbkssj_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_min']; 
          $zbkssj_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_seg']; 
          $zbkssj_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_cg_zbgg_help.txt"))
   {
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['psq_check_ret']['cgfs'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['psq_check_ret']['cgfs'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['shzt'])) ? $this->New_label['shzt'] : "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_shzt'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_shzt_cond" name="shzt_cond" onChange="nm_campos_between(document.getElementById('id_vis_shzt'), this, 'shzt')">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['psq_check_ret']['shzt'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['psq_check_ret']['shzt'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
      ...
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            echo "           <INPUT class=\"scFilterObjectEven\" type=\"checkbox\" id=\"SC_shzt\" name=\"shzt[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
            if (2 == $i && $j < sizeof($nm_opcoes) - 1)
            {
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['zbkssj'])) ? $this->New_label['zbkssj'] : "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_zbkssj'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_zbkssj_cond" name="zbkssj_cond" onChange="nm_campos_between(document.getElementById('id_vis_zbkssj'), this, 'zbkssj')">
     ...
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_zbkssj" style="display:none"></SPAN>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_zbkssj_dia" name="zbkssj_dia" value="<?php echo NM_encode_input($zbkssj_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.zbkssj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_zbkssj_mes" name="zbkssj_mes" value="<?php echo NM_encode_input($zbkssj_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.zbkssj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_zbkssj_ano" name="zbkssj_ano" value="<?php echo NM_encode_input($zbkssj_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
<INPUT type="hidden" id="sc_zbkssj_jq">
        <SPAN id="id_css_zbkssj"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_zbkssj"  <?php echo $str_display_zbkssj; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_zbkssj_input_2_dia" name="zbkssj_input_2_dia" value="<?php echo NM_encode_input($zbkssj_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.zbkssj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_zbkssj_input_2_mes" name="zbkssj_input_2_mes" value="<?php echo NM_encode_input($zbkssj_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.zbkssj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_zbkssj_input_2_ano" name="zbkssj_input_2_ano" value="<?php echo NM_encode_input($zbkssj_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_zbgg']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_zbgg']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['orig_pesq'] == "grid")
   {
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_zbkssj_dia').bind('change', function() {sc_grid_cg_zbgg_valida_dia(this)});
    $('#SC_zbkssj_input_2_dia').bind('change', function() {sc_grid_cg_zbgg_valida_dia(this)});
    $('#SC_zbkssj_input_2_mes').bind('change', function() {sc_grid_cg_zbgg_valida_mes(this)});
    $('#SC_zbkssj_mes').bind('change', function() {sc_grid_cg_zbgg_valida_mes(this)});
 }
 function sc_grid_cg_zbgg_valida_dia(obj)
 {
 ...
 function sc_grid_cg_zbgg_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (is_array($cgfs)) {
          foreach ($cgfs as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['psq_check_ret']['cgfs'])) {
      ...
      if (is_array($shzt)) {
          foreach ($shzt as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['psq_check_ret']['shzt'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_shzt'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgbbh'] = $cgbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgbbh_cond'] = $cgbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgbmc'] = $cgbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgbmc_cond'] = $cgbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgfs'] = $cgfs; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgfs_cond'] = $cgfs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['shzt'] = $shzt; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['shzt_cond'] = $shzt_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_dia'] = $zbkssj_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_mes'] = $zbkssj_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_ano'] = $zbkssj_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_dia'] = $zbkssj_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_mes'] = $zbkssj_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_ano'] = $zbkssj_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_hor'] = $zbkssj_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_min'] = $zbkssj_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_seg'] = $zbkssj_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_hor'] = $zbkssj_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_min'] = $zbkssj_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2_seg'] = $zbkssj_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_cond'] = $zbkssj_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['cgfs'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['cgfs'];
      $this->cmp_formatado['cgfs_input_2'] = $cgfs_input_2;
      $this->cmp_formatado['shzt'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['shzt'];
      ...
      if (count($cgfs) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label['cgfs'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($shzt) != 0)
      {
         ...
         if (strtoupper($shzt_cond) == "DF" || strtoupper($shzt_cond) == "NP")
         {
             ...
             $this->comando_sum    .= " cg_zbgg.shzt not in (";
             $this->comando_filtro .= " shzt not in (";
         }
         else
         {
             $this->comando        .= " shzt in (";
             $this->comando_sum    .= " cg_zbgg.shzt in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $nmgp_tab_label['shzt'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if ($zbkssj_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj'] = $val[0];
          ...
          if ($zbkssj_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']['zbkssj_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['where_pesq_ant'] = $this->comando . $this->comando_fim;
