<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_eval_plan_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_eval_plan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['cpbmc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cpbmc'] = "cpbmc";
       $tab_converte["cpbmc"]   = "cpbmc";
   }
   else
   {
       $tab_def_campos['cpbmc'] = "b.mc";
       $tab_converte["b.mc"]   = "cpbmc";
   }
   $tab_labels["cpbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["cpbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["cpbmc"] : "" . $this->Nm_lang['lang_eval_cpresult_fld_cpbmc'] . "";
   $tab_ger_campos['p_cgbbh'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_cgbbh'] = "p_cgbbh";
       $tab_converte["p_cgbbh"]   = "p_cgbbh";
   }
   else
   {
       $tab_def_campos['p_cgbbh'] = "p.cgbbh";
       $tab_converte["p.cgbbh"]   = "p_cgbbh";
   }
   $tab_labels["p_cgbbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_cgbbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_cgbbh"] : "" . $this->Nm_lang['lang_eval_plan_fld_cgbbh'] . "";
   $tab_ger_campos['p_cgbmc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_cgbmc'] = "p_cgbmc";
       $tab_converte["p_cgbmc"]   = "p_cgbmc";
   }
   else
   {
       $tab_def_campos['p_cgbmc'] = "p.cgbmc";
       $tab_converte["p.cgbmc"]   = "p_cgbmc";
   }
   $tab_labels["p_cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_cgbmc"] : "" . $this->Nm_lang['lang_eval_plan_fld_cgbmc'] . "";
   $tab_ger_campos['p_qymc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_qymc'] = "p_qymc";
       $tab_converte["p_qymc"]   = "p_qymc";
   }
   else
   {
       $tab_def_campos['p_qymc'] = "p.qymc";
       $tab_converte["p.qymc"]   = "p_qymc";
   }
   $tab_labels["p_qymc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_qymc"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_qymc"] : "" . $this->Nm_lang['lang_eval_plan_fld_qymc'] . "";
   $tab_ger_campos['p_begintime'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_begintime'] = "p_begintime";
       $tab_converte["p_begintime"]   = "p_begintime";
   }
   else
   {
       $tab_def_campos['p_begintime'] = "p.begintime";
       $tab_converte["p.begintime"]   = "p_begintime";
   }
   $tab_labels["p_begintime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_begintime"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_begintime"] : "" . $this->Nm_lang['lang_eval_plan_fld_begintime'] . "";
   $tab_ger_campos['p_endtime'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_endtime'] = "p_endtime";
       $tab_converte["p_endtime"]   = "p_endtime";
   }
   else
   {
       $tab_def_campos['p_endtime'] = "p.endtime";
       $tab_converte["p.endtime"]   = "p_endtime";
   }
   $tab_labels["p_endtime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_endtime"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_endtime"] : "" . $this->Nm_lang['lang_eval_plan_fld_endtime'] . "";
   $tab_ger_campos['p_tjsj'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_tjsj'] = "p_tjsj";
       $tab_converte["p_tjsj"]   = "p_tjsj";
   }
   else
   {
       $tab_def_campos['p_tjsj'] = "p.tjsj";
       $tab_converte["p.tjsj"]   = "p_tjsj";
   }
   $tab_labels["p_tjsj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_tjsj"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['labels']["p_tjsj"] : "" . $this->Nm_lang['lang_eval_plan_fld_tjsj'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_eval_plan']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_eval_plan'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_eval_plan_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_eval_plan']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
