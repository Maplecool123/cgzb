...
Table_sv_fil[0] = "cpbmc";
Table_sv_fil[1] = "p_cgbbh";
Table_sv_fil[2] = "p_cgbmc";
Table_sv_fil[3] = "p_qymc";
Table_sv_fil[4] = "p_tjsj";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
      ...
      success: function(json_sel_fil) {
        ...
        if ($("#SC_p_tjsj_cond")) {
            formata_bi_p_tjsj(search_get_sel_txt("SC_p_tjsj_cond"));
        }
