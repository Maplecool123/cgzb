...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $Nm_lang['lang_tbl_sec_apps'] ?> :: PDF</title>
...
$_SESSION['sc_session'][$aParams['script_case_init']]['sec_grid_sec_apps'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
