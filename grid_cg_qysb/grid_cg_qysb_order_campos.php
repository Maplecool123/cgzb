<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_qysb_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_qysb_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_cg_qysb_fld_cgbmc'] . "";
   $tab_ger_campos['qymc'] = "on";
   $tab_def_campos['qymc'] = "qymc";
   $tab_converte["qymc"]   = "qymc";
   $tab_labels["qymc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["qymc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["qymc"] : "" . $this->Nm_lang['lang_cg_qysb_fld_qymc'] . "";
   $tab_ger_campos['isbsxz'] = "on";
   $tab_def_campos['isbsxz'] = "isbsxz";
   $tab_converte["isbsxz"]   = "isbsxz";
   $tab_labels["isbsxz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["isbsxz"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["isbsxz"] : "" . $this->Nm_lang['lang_cg_qysb_fld_isbsxz'] . "";
   $tab_ger_campos['istb'] = "on";
   $tab_def_campos['istb'] = "istb";
   $tab_converte["istb"]   = "istb";
   $tab_labels["istb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["istb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["istb"] : "" . $this->Nm_lang['lang_cg_qysb_fld_istb'] . "";
   $tab_ger_campos['isrw'] = "on";
   $tab_def_campos['isrw'] = "isrw";
   $tab_converte["isrw"]   = "isrw";
   $tab_labels["isrw"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["isrw"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["isrw"] : "" . $this->Nm_lang['lang_cg_qysb_fld_isrw'] . "";
   $tab_ger_campos['isqualified'] = "on";
   $tab_def_campos['isqualified'] = "isqualified";
   $tab_converte["isqualified"]   = "isqualified";
   $tab_labels["isqualified"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["isqualified"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["isqualified"] : "" . $this->Nm_lang['lang_cg_qysb_fld_isqualified'] . "";
   $tab_ger_campos['kyzt'] = "on";
   $tab_def_campos['kyzt'] = "kyzt";
   $tab_converte["kyzt"]   = "kyzt";
   $tab_labels["kyzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["kyzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["kyzt"] : "" . $this->Nm_lang['lang_cg_qysb_fld_kyzt'] . "";
   ...
   $tab_labels["spgl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["spgl"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['labels']["spgl"] : "操作";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_menu_cg_qysb'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_qysb_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_qysb']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
