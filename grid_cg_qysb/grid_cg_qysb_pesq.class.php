...
class grid_cg_qysb_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_qysb_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_qysb_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_qysb_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_qysb'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_qysb/grid_cg_qysb_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_qysb_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_qysb_ajax.js"></script>
 <script type="text/javascript">
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_qysb'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cgbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['cgbbh']; 
          $cgbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['cgbbh_cond']; 
          $cgbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['cgbmc']; 
          $cgbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['cgbmc_cond']; 
          $qymc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['qymc']; 
          $qymc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['qymc_cond']; 
          $lxr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['lxr']; 
          $lxr_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['lxr_cond']; 
          $qylogin = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['qylogin']; 
          $qylogin_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['qylogin_cond']; 
          $kyzt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['kyzt']; 
          $kyzt_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['kyzt_cond']; 
          $isbsxz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isbsxz']; 
          $isbsxz_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isbsxz_cond']; 
          $istb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['istb']; 
          $istb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['istb_cond']; 
          $isrw = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isrw']; 
          $isrw_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isrw_cond']; 
          $isqualified = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isqualified']; 
          $isqualified_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isqualified_cond']; 
          $dlsj_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_dia']; 
          $dlsj_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_mes']; 
          $dlsj_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_ano']; 
          $dlsj_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_dia']; 
          $dlsj_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_mes']; 
          $dlsj_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_ano']; 
          $dlsj_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_hor']; 
          $dlsj_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_min']; 
          $dlsj_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_seg']; 
          $dlsj_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_hor']; 
          $dlsj_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_min']; 
          $dlsj_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_seg']; 
          $dlsj_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_cg_qysb_help.txt"))
   {
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgbmc" name="cgbmc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['qymc'])) ? $this->New_label['qymc'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_qymc'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
<INPUT  type="text" id="SC_qymc" name="qymc" value="<?php echo NM_encode_input($qymc) ?>" size=32 alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_qymc" name="qymc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['lxr'])) ? $this->New_label['lxr'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_lxr'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_lxr" name="lxr_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['qylogin'])) ? $this->New_label['qylogin'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_qylogin'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_qylogin" name="qylogin_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['kyzt'])) ? $this->New_label['kyzt'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_kyzt'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['kyzt'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['kyzt'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['kyzt'][] = "否";
 ?>
...
<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
 ...
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('kyzt', 'N'); return false;" style="cursor: pointer">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['isbsxz'])) ? $this->New_label['isbsxz'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isbsxz'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_isbsxz_cond" name="isbsxz_cond" onChange="nm_campos_between(document.getElementById('id_vis_isbsxz'), this, 'isbsxz')">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isbsxz'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isbsxz'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isbsxz'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_isbsxz" name="isbsxz[]" value="是##@@是"  <?php if (in_array("是", $isbsxz))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_isbsxz" name="isbsxz[]" value="否##@@否"  <?php if (in_array("否", $isbsxz))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('isbsxz', 'N'); return false;" style="cursor: pointer">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['istb'])) ? $this->New_label['istb'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_istb'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_istb_cond" name="istb_cond" onChange="nm_campos_between(document.getElementById('id_vis_istb'), this, 'istb')">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['istb'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['istb'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['istb'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_istb" name="istb[]" value="是##@@是"  <?php if (in_array("是", $istb))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_istb" name="istb[]" value="否##@@否"  <?php if (in_array("否", $istb))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('istb', 'N'); return false;" style="cursor: pointer">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['isrw'])) ? $this->New_label['isrw'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isrw'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_isrw_cond" name="isrw_cond" onChange="nm_campos_between(document.getElementById('id_vis_isrw'), this, 'isrw')">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isrw'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isrw'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isrw'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_isrw" name="isrw[]" value="是##@@是"  <?php if (in_array("是", $isrw))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_isrw" name="isrw[]" value="否##@@否"  <?php if (in_array("否", $isrw))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('isrw', 'N'); return false;" style="cursor: pointer">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['isqualified'])) ? $this->New_label['isqualified'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isqualified'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_isqualified_cond" name="isqualified_cond" onChange="nm_campos_between(document.getElementById('id_vis_isqualified'), this, 'isqualified')">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isqualified'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isqualified'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isqualified'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_isqualified" name="isqualified[]" value="是##@@是"  <?php if (in_array("是", $isqualified))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_isqualified" name="isqualified[]" value="否##@@否"  <?php if (in_array("否", $isqualified))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('isqualified', 'N'); return false;" style="cursor: pointer">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['dlsj'])) ? $this->New_label['dlsj'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_dlsj'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dlsj_cond" name="dlsj_cond" onChange="nm_campos_between(document.getElementById('id_vis_dlsj'), this, 'dlsj')">
     ...
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_dlsj" style="display:none"></SPAN>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dlsj_dia" name="dlsj_dia" value="<?php echo NM_encode_input($dlsj_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.dlsj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dlsj_mes" name="dlsj_mes" value="<?php echo NM_encode_input($dlsj_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.dlsj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dlsj_ano" name="dlsj_ano" value="<?php echo NM_encode_input($dlsj_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
<INPUT type="hidden" id="sc_dlsj_jq">
        <SPAN id="id_css_dlsj"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_dlsj"  <?php echo $str_display_dlsj; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dlsj_input_2_dia" name="dlsj_input_2_dia" value="<?php echo NM_encode_input($dlsj_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.dlsj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dlsj_input_2_mes" name="dlsj_input_2_mes" value="<?php echo NM_encode_input($dlsj_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.dlsj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_dlsj_input_2_ano" name="dlsj_input_2_ano" value="<?php echo NM_encode_input($dlsj_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_qysb']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_qysb']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['orig_pesq'] == "grid")
   {
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_dlsj_dia').bind('change', function() {sc_grid_cg_qysb_valida_dia(this)});
    $('#SC_dlsj_input_2_dia').bind('change', function() {sc_grid_cg_qysb_valida_dia(this)});
    $('#SC_dlsj_input_2_mes').bind('change', function() {sc_grid_cg_qysb_valida_mes(this)});
    $('#SC_dlsj_mes').bind('change', function() {sc_grid_cg_qysb_valida_mes(this)});
 }
 function sc_grid_cg_qysb_valida_dia(obj)
 {
 ...
 function sc_grid_cg_qysb_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (is_array($kyzt)) {
          foreach ($kyzt as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['kyzt'])) {
      ...
      if (is_array($isbsxz)) {
          foreach ($isbsxz as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isbsxz'])) {
      ...
      if (is_array($istb)) {
          foreach ($istb as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['istb'])) {
      ...
      if (is_array($isrw)) {
          foreach ($isrw as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isrw'])) {
      ...
      if (is_array($isqualified)) {
          foreach ($isqualified as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['psq_check_ret']['isqualified'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['cgbbh'] = $cgbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['cgbbh_cond'] = $cgbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['cgbmc'] = $cgbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['cgbmc_cond'] = $cgbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['qymc'] = $qymc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['qymc_cond'] = $qymc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['lxr'] = $lxr; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['lxr_cond'] = $lxr_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['qylogin'] = $qylogin; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['qylogin_cond'] = $qylogin_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['kyzt'] = $kyzt; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['kyzt_cond'] = $kyzt_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isbsxz'] = $isbsxz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isbsxz_cond'] = $isbsxz_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['istb'] = $istb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['istb_cond'] = $istb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isrw'] = $isrw; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isrw_cond'] = $isrw_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isqualified'] = $isqualified; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isqualified_cond'] = $isqualified_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_dia'] = $dlsj_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_mes'] = $dlsj_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_ano'] = $dlsj_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_dia'] = $dlsj_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_mes'] = $dlsj_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_ano'] = $dlsj_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_hor'] = $dlsj_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_min'] = $dlsj_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_seg'] = $dlsj_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_hor'] = $dlsj_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_min'] = $dlsj_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2_seg'] = $dlsj_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_cond'] = $dlsj_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['kyzt'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['kyzt'];
      $this->cmp_formatado['kyzt_input_2'] = $kyzt_input_2;
      $this->cmp_formatado['isbsxz'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isbsxz'];
      $this->cmp_formatado['isbsxz_input_2'] = $isbsxz_input_2;
      $this->cmp_formatado['istb'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['istb'];
      $this->cmp_formatado['istb_input_2'] = $istb_input_2;
      $this->cmp_formatado['isrw'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isrw'];
      $this->cmp_formatado['isrw_input_2'] = $isrw_input_2;
      $this->cmp_formatado['isqualified'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['isqualified'];
      ...
      if (count($kyzt) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label['kyzt'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($isbsxz) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label['isbsxz'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($istb) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label['istb'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($isrw) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label['isrw'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($isqualified) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $nmgp_tab_label['isqualified'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if ($dlsj_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj'] = $val[0];
          ...
          if ($dlsj_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']['dlsj_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb']['where_pesq_ant'] = $this->comando . $this->comando_fim;
