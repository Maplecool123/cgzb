...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_qysb"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_qysb"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cg_qysb'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_qysb']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_qysb']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_qysb']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_qysb']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cg_qysb']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cg_qysb']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cg_qysb']['embutida_filho'] as $ind => $sc_init)
          {
