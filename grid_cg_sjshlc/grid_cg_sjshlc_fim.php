...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_sjshlc"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_sjshlc"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_sjshlc']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_sjshlc']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_sjshlc']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_sjshlc']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cg_sjshlc']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cg_sjshlc']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cg_sjshlc']['embutida_filho'] as $ind => $sc_init)
          {
