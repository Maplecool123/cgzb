<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_sjshlc_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_sjshlc_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["shbz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["shbz"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["shbz"] : "" . $this->Nm_lang['lang_cg_sjshlc_fld_shbz'] . "";
   $tab_ger_campos['shyj'] = "on";
   $tab_def_campos['shyj'] = "shyj";
   $tab_converte["shyj"]   = "shyj";
   $tab_labels["shyj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["shyj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["shyj"] : "" . $this->Nm_lang['lang_cg_sjshlc_fld_shyj'] . "";
   $tab_ger_campos['fj'] = "on";
   $tab_def_campos['fj'] = "fj";
   $tab_converte["fj"]   = "fj";
   $tab_labels["fj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["fj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["fj"] : "" . $this->Nm_lang['lang_cg_sjshlc_fld_fj'] . "";
   $tab_ger_campos['tjr'] = "on";
   $tab_def_campos['tjr'] = "tjr";
   $tab_converte["tjr"]   = "tjr";
   $tab_labels["tjr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["tjr"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["tjr"] : "" . $this->Nm_lang['lang_cg_sjshlc_fld_tjr'] . "";
   $tab_ger_campos['shsj'] = "on";
   $tab_def_campos['shsj'] = "shsj";
   $tab_converte["shsj"]   = "shsj";
   $tab_labels["shsj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["shsj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["shsj"] : "" . $this->Nm_lang['lang_cg_sjshlc_fld_shsj'] . "";
   $tab_ger_campos['shzt'] = "on";
   $tab_def_campos['shzt'] = "shzt";
   $tab_converte["shzt"]   = "shzt";
   $tab_labels["shzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["shzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['labels']["shzt"] : "" . $this->Nm_lang['lang_cg_sjshlc_fld_shzt'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_sjshlc'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_sjshlc_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_sjshlc']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
