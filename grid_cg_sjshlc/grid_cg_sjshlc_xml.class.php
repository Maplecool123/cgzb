...
class grid_cg_sjshlc_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_cg_sjshlc.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_cg_sjshlc";
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->shyj))
         {
             $this->shyj = sc_convert_encoding($this->shyj, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " shyj =\"" . $this->trata_dados($this->shyj) . "\"";
   }
   //----- fj
   function NM_export_fj()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->fj))
         {
             $this->fj = sc_convert_encoding($this->fj, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " fj =\"" . $this->trata_dados($this->fj) . "\"";
   }
   //----- tjr
   ...
   function NM_export_shsj()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->shsj))
         {
             $this->shsj = sc_convert_encoding($this->shsj, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " shsj =\"" . $this->trata_dados($this->shsj) . "\"";
   }
   //----- shzt
   ...
   function NM_export_sjbh()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->sjbh))
         {
             $this->sjbh = sc_convert_encoding($this->sjbh, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " sjbh =\"" . $this->trata_dados($this->sjbh) . "\"";
   }
   //----- shlc
   function NM_export_shlc()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->shlc))
         {
             $this->shlc = sc_convert_encoding($this->shlc, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " shlc =\"" . $this->trata_dados($this->shlc) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_sjshlc'] ?> :: XML</TITLE>
