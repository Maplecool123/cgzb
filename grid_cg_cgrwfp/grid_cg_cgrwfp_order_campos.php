<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_cgrwfp_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_cgrwfp_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cgbbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgbbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgbbh"] : "" . $this->Nm_lang['lang_cg_cgrwfp_fld_cgbbh'] . "";
   $tab_ger_campos['cgbmc'] = "on";
   $tab_def_campos['cgbmc'] = "cgbmc";
   $tab_converte["cgbmc"]   = "cgbmc";
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_cg_cgrwfp_fld_cgbmc'] . "";
   $tab_ger_campos['cgys'] = "on";
   $tab_def_campos['cgys'] = "cgys";
   $tab_converte["cgys"]   = "cgys";
   $tab_labels["cgys"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgys"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgys"] : "" . $this->Nm_lang['lang_cg_cgrwfp_fld_cgys'] . "";
   $tab_ger_campos['cgfs'] = "on";
   $tab_def_campos['cgfs'] = "cgfs";
   $tab_converte["cgfs"]   = "cgfs";
   $tab_labels["cgfs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgfs"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgfs"] : "" . $this->Nm_lang['lang_cg_cgrwfp_fld_cgfs'] . "";
   $tab_ger_campos['cgyxm'] = "on";
   $tab_def_campos['cgyxm'] = "cgyxm";
   $tab_converte["cgyxm"]   = "cgyxm";
   $tab_labels["cgyxm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgyxm"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgyxm"] : "" . $this->Nm_lang['lang_cg_cgrwfp_fld_cgyxm'] . "";
   $tab_ger_campos['cgylxdh'] = "on";
   $tab_def_campos['cgylxdh'] = "cgylxdh";
   $tab_converte["cgylxdh"]   = "cgylxdh";
   $tab_labels["cgylxdh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgylxdh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgylxdh"] : "" . $this->Nm_lang['lang_cg_cgrwfp_fld_cgylxdh'] . "";
   $tab_ger_campos['cgzt'] = "on";
   $tab_def_campos['cgzt'] = "cgzt";
   $tab_converte["cgzt"]   = "cgzt";
   $tab_labels["cgzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['labels']["cgzt"] : "" . $this->Nm_lang['lang_cg_cgrwfp_fld_cgzt'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_cgrwfp'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_cgrwfp_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_cgrwfp']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
