...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_cgrwfp'] ?></TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgbbh'])) ? $this->New_label['cgbbh'] : "" . $this->Ini->Nm_lang['lang_cg_cgrwfp_fld_cgbbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cgbbh" name="cgbbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgbmc'])) ? $this->New_label['cgbmc'] : "" . $this->Ini->Nm_lang['lang_cg_cgrwfp_fld_cgbmc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgbmc" name="cgbmc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgybh'])) ? $this->New_label['cgybh'] : "" . $this->Ini->Nm_lang['lang_cg_cgrwfp_fld_cgybh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cgybh" name="cgybh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgyxm'])) ? $this->New_label['cgyxm'] : "" . $this->Ini->Nm_lang['lang_cg_cgrwfp_fld_cgyxm'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgyxm" name="cgyxm_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgfs'])) ? $this->New_label['cgfs'] : "" . $this->Ini->Nm_lang['lang_cg_cgrwfp_fld_cgfs'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgzt'])) ? $this->New_label['cgzt'] : "" . $this->Ini->Nm_lang['lang_cg_cgrwfp_fld_cgzt'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cgzt" <?php echo $str_hide_cgzt?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
