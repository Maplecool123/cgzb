...
class grid_cg_cgrwfp_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_cg_cgrwfp.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgrwfp']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgrwfp']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgrwfp']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgrwfp']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_cg_cgrwfp";
   ...
   function NM_export_cgys()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->cgys))
         {
             $this->cgys = sc_convert_encoding($this->cgys, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " cgys =\"" . $this->trata_dados($this->cgys) . "\"";
   }
   //----- cgfs
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->cgzt))
         {
             $this->cgzt = sc_convert_encoding($this->cgzt, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " cgzt =\"" . $this->trata_dados($this->cgzt) . "\"";
   }
   //----- cgybh
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgrwfp']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgrwfp']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_cgrwfp'] ?> :: XML</TITLE>
