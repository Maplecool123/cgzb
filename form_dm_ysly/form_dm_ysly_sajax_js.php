  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dm_ysly" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate dm_
  function do_ajax_form_dm_ysly_validate_dm_(iNumLinha)
  {
    var nomeCampo_dm_ = "dm_" + iNumLinha;
    var var_dm_ = scAjaxGetFieldText(nomeCampo_dm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dm_ysly_validate_dm_(var_dm_, iNumLinha, var_script_case_init, do_ajax_form_dm_ysly_validate_dm__cb);
  } // do_ajax_form_dm_ysly_validate_dm_

  function do_ajax_form_dm_ysly_validate_dm__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dm_ysly_validate_dm__cb

  // ---------- Validate mc_
  function do_ajax_form_dm_ysly_validate_mc_(iNumLinha)
  {
    var nomeCampo_mc_ = "mc_" + iNumLinha;
    var var_mc_ = scAjaxGetFieldText(nomeCampo_mc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dm_ysly_validate_mc_(var_mc_, iNumLinha, var_script_case_init, do_ajax_form_dm_ysly_validate_mc__cb);
  } // do_ajax_form_dm_ysly_validate_mc_

  function do_ajax_form_dm_ysly_validate_mc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dm_ysly_validate_mc__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dm_ysly_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dm_ysly_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dm_ysly_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dm_ysly_add_new_line_cb);
  } // do_ajax_form_dm_ysly_add_new_line

  function do_ajax_form_dm_ysly_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_dm_ysly_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dm_ysly_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dm_ysly_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dm_ysly_backup_line_cb);
  } // do_ajax_form_dm_ysly_backup_line

  function do_ajax_form_dm_ysly_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_dm_ysly_backup_line_cb

  function do_ajax_form_dm_ysly_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dm_ysly_cancel_insert

  function do_ajax_form_dm_ysly_cancel_update(iSeqVert)
  {
    do_ajax_form_dm_ysly_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dm_ysly_cancel_update

  function do_ajax_form_dm_ysly_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dm_ysly_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dm_ysly_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_dm_ysly_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dm_ysly_table_refresh_cb);
  } //  do_ajax_form_dm_ysly_table_refresh

  function do_ajax_form_dm_ysly_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_dm_ysly_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dm_ysly_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dm_ysly_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_dm_ysly_submit_form(var_dm_, var_mc_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dm_ysly_submit_form_cb);
  } // do_ajax_form_dm_ysly_submit_form

  function do_ajax_form_dm_ysly_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_dm_ysly_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_dm_ysly_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dm_ysly_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dm_ysly_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dm_ysly_navigate_form_cb);
  } // do_ajax_form_dm_ysly_navigate_form

  function do_ajax_form_dm_ysly_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_dm_ysly_navigate_form_cb
  function sc_hide_form_dm_ysly_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_dm_ysly_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["dm_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dm_ysly_fld_dm'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mc_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dm_ysly_fld_mc'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
