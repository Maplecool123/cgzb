...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "intime";$Nm_datas[] = "reviewtime";$Nm_numeric[] = "id";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_intime"  <?php echo $str_hide_intime?>>
<SPAN id="Nm_bi_dados_intime" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_intime"  style="display:''">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_status"  <?php echo $str_hide_status?>>
<?php
