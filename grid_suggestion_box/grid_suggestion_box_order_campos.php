<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_suggestion_box_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_suggestion_box_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["subject"]   = "subject";
   $tab_labels["subject"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['labels']["subject"])) ? $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['labels']["subject"] : "" . $this->Nm_lang['lang_suggestion_box_fld_subject'] . "";
   $tab_ger_campos['phone'] = "on";
   $tab_def_campos['phone'] = "phone";
   $tab_converte["phone"]   = "phone";
   $tab_labels["phone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['labels']["phone"])) ? $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['labels']["phone"] : "" . $this->Nm_lang['lang_suggestion_box_fld_phone'] . "";
   $tab_ger_campos['intime'] = "on";
   $tab_def_campos['intime'] = "intime";
   $tab_converte["intime"]   = "intime";
   $tab_labels["intime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['labels']["intime"])) ? $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['labels']["intime"] : "" . $this->Nm_lang['lang_suggestion_box_fld_intime'] . "";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_converte["status"]   = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['labels']["status"] : "" . $this->Nm_lang['lang_suggestion_box_fld_status'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_suggestion_box_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_suggestion_box']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
