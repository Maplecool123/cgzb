...
class grid_suggestion_box_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_suggestion_box_pesq()
   {
      $this->intime_opc_bi[] = "TP";
      $this->intime_opc_bi[] = "HJ";
      $this->intime_opc_bi[] = "OT";
      $this->intime_opc_bi[] = "U7";
      $this->intime_opc_bi[] = "SP";
      $this->intime_opc_bi[] = "US";
      $this->intime_opc_bi[] = "MM";
      $this->intime_opc_bi[] = "UM";
      $this->intime_opc_bi[] = "CY";
      $this->intime_opc_bi[] = "LY";
      $this->intime_opc_bi[] = "M24";
      $this->intime_opc_bi[] = "M18";
      $this->intime_opc_bi[] = "YY";
      $this->intime_opc_bi[] = "M6";
      $this->intime_opc_bi[] = "M3";
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_suggestion_box_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_suggestion_box_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_suggestion_box_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_subject($subject)
   {
      ...
      $nm_comando = "select distinct subject from " . $this->Ini->nm_tabela . " where  subject like '%" . $subject . "%'"; 
   ...
   function lookup_ajax_content($content)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct content from " . $this->Ini->nm_tabela . " where  content like '%" . $content . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_phone($phone)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct phone from " . $this->Ini->nm_tabela . " where  phone like '%" . $phone . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "intime";$Nm_datas[] = "reviewtime";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_suggestion_box'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_suggestion_box/grid_suggestion_box_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_suggestion_box_ajax_search.js"></script>
 <script type="text/javascript" src="grid_suggestion_box_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  opc = search_get_sel_txt('SC_intime_cond');
  if (opc != "TP" && opc != "HJ" && opc != "OT" && opc != "U7" && opc != "SP" && opc != "US" && opc != "MM" && opc != "UM" && opc != "AM" && opc != "PS" && opc != "SS" && opc != "P3" && opc != "PM" && opc != "P7" && opc != "CY" && opc != "LY" && opc != "YY" && opc != "M6" && opc != "M3" && opc != "M18" && opc != "M24")
  {
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_suggestion_box'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $intime_cond, $intime, $intime_dia, $intime_mes, $intime_ano, $intime_hor, $intime_min, $intime_seg, $intime_input_2_dia, $intime_input_2_mes, $intime_input_2_ano, $intime_input_2_min, $intime_input_2_hor, $intime_input_2_seg,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $subject = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['subject']; 
          $subject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['subject_cond']; 
          $content = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['content']; 
          $content_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['content_cond']; 
          $intime_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_dia']; 
          $intime_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_mes']; 
          $intime_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_ano']; 
          $intime_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_dia']; 
          $intime_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_mes']; 
          $intime_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_ano']; 
          $intime_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_hor']; 
          $intime_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_min']; 
          $intime_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_seg']; 
          $intime_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_hor']; 
          $intime_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_min']; 
          $intime_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_seg']; 
          $intime_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_cond']; 
          $phone = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['phone']; 
          $phone_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['phone_cond']; 
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['status']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['status_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['NM_operador']; 
      } 
      ...
      if (isset($intime_cond) && in_array($intime_cond, $this->intime_opc_bi))
      {
         $Temp_cond = $intime_cond;
         $this->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $intime_dia = substr($BI_data1, 0, 2);
         $intime_mes = substr($BI_data1, 2, 2);
         $intime_ano = substr($BI_data1, 4);
         $intime_input_2_dia = substr($BI_data2, 0, 2);
         $intime_input_2_mes = substr($BI_data2, 2, 2);
         $intime_input_2_ano = substr($BI_data2, 4);
         $Script_BI .= "  formata_bi_intime('" . $intime_cond . "');\r\n";
      }
...
<?php
   if (is_file("grid_suggestion_box_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['subject'])) ? $this->New_label['subject'] : "" . $this->Ini->Nm_lang['lang_suggestion_box_fld_subject'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_subject_cond" name="subject_cond" onChange="nm_campos_between(document.getElementById('id_vis_subject'), this, 'subject')">
...
<?php
      $subject_look = substr($this->Db->qstr($subject), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct subject from " . $this->Ini->nm_tabela . " where subject = '$subject_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_subject" name="subject" value="<?php echo NM_encode_input($subject) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_subject" name="subject_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['content'])) ? $this->New_label['content'] : "" . $this->Ini->Nm_lang['lang_suggestion_box_fld_content'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_content_cond" name="content_cond" onChange="nm_campos_between(document.getElementById('id_vis_content'), this, 'content')">
...
<?php
      $content_look = substr($this->Db->qstr($content), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct content from " . $this->Ini->nm_tabela . " where content = '$content_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_content" name="content" value="<?php echo NM_encode_input($content) ?>" size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_content" name="content_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['intime'])) ? $this->New_label['intime'] : "" . $this->Ini->Nm_lang['lang_suggestion_box_fld_intime'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_intime_cond" name="intime_cond" onChange="nm_campos_between(document.getElementById('id_vis_intime'), this, 'intime')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="TP" <?php if ("TP" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_ever'] ?></OPTION>
       <OPTION value="HJ" <?php if ("HJ" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="OT" <?php if ("OT" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="U7" <?php if ("U7" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lst7'] ?></OPTION>
       <OPTION value="SP" <?php if ("SP" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw'] ?></OPTION>
       <OPTION value="US" <?php if ("US" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw_bsnd'] ?></OPTION>
       <OPTION value="MM" <?php if ("MM" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_this_mnth'] ?></OPTION>
       <OPTION value="UM" <?php if ("UM" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="CY" <?php if ("CY" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_curr_year'] ?></OPTION>
       <OPTION value="LY" <?php if ("LY" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="M24" <?php if ("M24" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_24mo'] ?></OPTION>
       <OPTION value="M18" <?php if ("M18" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_18mo'] ?></OPTION>
       <OPTION value="YY" <?php if ("YY" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_12mo'] ?></OPTION>
       <OPTION value="M6" <?php if ("M6" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_06mo'] ?></OPTION>
       <OPTION value="M3" <?php if ("M3" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_nrml'] ?>">
       <OPTION value="eq" <?php if ("eq" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $intime_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_intime" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_intime"  style=display:  border="0" cellpadding="0" cellspacing="0">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_intime_dia" name="intime_dia" value="<?php echo NM_encode_input($intime_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.intime_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_intime_mes" name="intime_mes" value="<?php echo NM_encode_input($intime_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.intime_cond.value)">
...
<INPUT type="hidden" id="sc_intime_jq">
        <SPAN id="id_css_intime"  class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_intime_input_2_dia" name="intime_input_2_dia" value="<?php echo NM_encode_input($intime_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.intime_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_intime_input_2_mes" name="intime_input_2_mes" value="<?php echo NM_encode_input($intime_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.intime_cond.value)">
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['phone'])) ? $this->New_label['phone'] : "" . $this->Ini->Nm_lang['lang_suggestion_box_fld_phone'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
      $phone_look = substr($this->Db->qstr($phone), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct phone from " . $this->Ini->nm_tabela . " where phone = '$phone_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_phone" name="phone" value="<?php echo NM_encode_input($phone) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_phone" name="phone_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['status'])) ? $this->New_label['status'] : "" . $this->Ini->Nm_lang['lang_suggestion_box_fld_status'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT name, name  FROM dm_reviewstate  ORDER BY id"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['psq_check_ret']['status'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['psq_check_ret']['status'][] = trim($rs->fields[0]);
      ...
      echo "<span id=\"idAjaxCheckbox_status\">\r\n";
      ...
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            echo "           <INPUT class=\"scFilterObjectOdd\" type=\"checkbox\" id=\"SC_status\" name=\"status[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
     ...
     echo "         <TR>\r\n";
     echo "          <TD colspan=3>\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_all.gif\" ALIGN=\"absmiddle\" onClick=\"nm_marca_check('status', 'N'); return false;\" style=\"cursor: pointer\">&nbsp;\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_none.gif\" ALIGN=\"absmiddle\" onClick=\"nm_limpa_check('status', 'N'); return false;\" style=\"cursor: pointer\">\r\n";
     echo "         </TR>\r\n";
      echo "        </TABLE>\r\n";
      echo "</span>\r\n";
?>
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_suggestion_box']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_suggestion_box']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   var opc_bi = document.F1.intime_cond.value;
   ...
   {
       document.F1.intime_cond.value = 'TP';
   }
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_intime_dia').bind('change', function() {sc_grid_suggestion_box_valida_dia(this)});
    $('#SC_intime_input_2_dia').bind('change', function() {sc_grid_suggestion_box_valida_dia(this)});
    $('#SC_intime_input_2_mes').bind('change', function() {sc_grid_suggestion_box_valida_mes(this)});
    $('#SC_intime_mes').bind('change', function() {sc_grid_suggestion_box_valida_mes(this)});
 }
 function sc_grid_suggestion_box_valida_dia(obj)
 {
 ...
 function sc_grid_suggestion_box_valida_mes(obj)
 {
...
function formata_bi_intime(opc)
{
   if (opc != "TP" && opc != "HJ" && opc != "OT" && opc != "U7" && opc != "SP" && opc != "US" && opc != "MM" && opc != "UM" && opc != "AM" && opc != "PS" && opc != "SS" && opc != "P3" && opc != "PM" && opc != "P7" && opc != "CY" && opc != "LY" && opc != "YY" && opc != "M6" && opc != "M3" && opc != "M18" && opc != "M24")
   {
       document.getElementById('Nm_bi_dados_intime').style.display = 'none';
       document.getElementById('opc_bi_TP_intime').style.display = '';
       return;
   }
   if (opc == "TP")
   {
       document.getElementById('Nm_bi_dados_intime').style.display = 'none';
       document.getElementById('opc_bi_TP_intime').style.display = 'none';
       return;
   }
<?php
   $date_format_show = "";
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.intime_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.intime_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.intime_ano.value" : "";
       $Prim = false;
   }
?> 
...
<?php
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.intime_input_2_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.intime_input_2_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.intime_input_2_ano.value" : "";
       $Prim = false;
   }
?> 
   saida += <?php echo $date_format_show ?>;
   }
   document.getElementById('Nm_bi_dados_intime').innerHTML = saida;
   document.getElementById('opc_bi_TP_intime').style.display = 'none';
   document.getElementById('Nm_bi_dados_intime').style.display = '';
}
<?php
  echo $Script_BI;
?>
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "cgzb/grid_suggestion_box";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $subject_cond, $subject, $subject_autocomp,
             $content_cond, $content, $content_autocomp,
             $intime_cond, $intime, $intime_dia, $intime_mes, $intime_ano, $intime_hor, $intime_min, $intime_seg, $intime_input_2_dia, $intime_input_2_mes, $intime_input_2_ano, $intime_input_2_min, $intime_input_2_hor, $intime_input_2_seg,
             $phone_cond, $phone, $phone_autocomp,
      ...
      if (!isset($intime_input_2_hor) || $intime_input_2_hor == "")
      {
          $intime_input_2_hor = $intime_hor;
      }
      if (!isset($intime_input_2_min) || $intime_input_2_min == "")
      {
          $intime_input_2_min = $intime_min;
      }
      if (!isset($intime_input_2_seg) || $intime_input_2_seg == "")
      {
          $intime_input_2_seg = $intime_seg;
      }
      ...
      if (is_array($status)) {
          foreach ($status as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['psq_check_ret']['status'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_suggestion_box_fld_status'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['subject'] = $subject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['subject_cond'] = $subject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['content'] = $content; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['content_cond'] = $content_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_dia'] = $intime_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_mes'] = $intime_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_ano'] = $intime_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_dia'] = $intime_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_mes'] = $intime_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_ano'] = $intime_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_hor'] = $intime_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_min'] = $intime_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_seg'] = $intime_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_hor'] = $intime_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_min'] = $intime_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2_seg'] = $intime_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_cond'] = $intime_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['phone'] = $phone; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['phone_cond'] = $phone_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['status'] = $status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['status_cond'] = $status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['status'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['status'];
      ...
      if ($intime_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime'] = $val[0];
          ...
          if ($intime_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']['intime_input_2'] = $val[1];
      ...
      {
         $this->and_or();
         if (strtoupper($status_cond) == "DF" || strtoupper($status_cond) == "NP")
         {
             $this->comando        .= " status not in (";
             $this->comando_sum    .= " suggestion_box.status not in (";
             $this->comando_filtro .= " status not in (";
         }
         else
         {
             $this->comando        .= " status in (";
             $this->comando_sum    .= " suggestion_box.status in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $nmgp_tab_label['status'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_suggestion_box']['where_pesq_ant'] = $this->comando . $this->comando_fim;
