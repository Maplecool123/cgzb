...
$_SESSION['scriptcase']['app_form_add_users']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users']['label'] = "" . $this->Ini->Nm_lang['lang_new_user'] . "";
...
;
    ...
    {
        global $teste_validade;
      if (($this->nmgp_opcao == "incluir" || 'validate_name' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['php_cmp_required']['name'] == "on"))
      { 
          if ($this->name == "")  
          { 
    ...
    {
        global $teste_validade;
      if (($this->nmgp_opcao == "incluir" || 'validate_gsmc' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['php_cmp_required']['gsmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['php_cmp_required']['gsmc'] == "on"))
      { 
          if ($this->gsmc == "")  
          { 
