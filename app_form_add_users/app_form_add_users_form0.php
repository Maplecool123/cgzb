...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_name_label" id="hidden_field_label_name" style="<?php echo $sStyleHidden_name; ?>"><span id="id_label_name"><?php echo $this->nm_new_label['name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['php_cmp_required']['name'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_gsmc_label" id="hidden_field_label_gsmc" style="<?php echo $sStyleHidden_gsmc; ?>"><span id="id_label_gsmc"><?php echo $this->nm_new_label['gsmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['php_cmp_required']['gsmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['php_cmp_required']['gsmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
