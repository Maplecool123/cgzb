...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "planbh";$Nm_numeric[] = "tbbh";$Nm_numeric[] = "zbggbh";$Nm_numeric[] = "yprs";$Nm_numeric[] = "zrs";$Nm_numeric[] = "zscj";$Nm_numeric[] = "id";$Nm_numeric[] = "planbh";$Nm_numeric[] = "tbbh";$Nm_numeric[] = "zbggbh";$Nm_numeric[] = "yprs";$Nm_numeric[] = "zrs";$Nm_numeric[] = "zscj";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_zscj"  <?php echo $str_hide_zscj?>><?php
      $zscj_look = substr($this->Db->qstr($zscj), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($zscj))
   { 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_zscj" name="zscj_autocomp" size="6" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_zscj"  <?php echo $str_display_zscj; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_zscj_input_2" name="zscj_input_2" value="<?php echo NM_encode_input($zscj_input_2) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
