...
class grid_eval_cpresult_pesq
{
    ...
    * @access  public
    */
   function grid_eval_cpresult_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_eval_cpresult_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_eval_cpresult_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_eval_cpresult_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_zscj')
      {
          $zscj = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_zscj($zscj);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_zscj($zscj)
   {
      $zscj = substr($this->Db->qstr($zscj), 1, -1);
            $zscj_look = substr($this->Db->qstr($zscj), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct zscj from " . $this->Ini->nm_tabela . " where  zscj like '%" . $zscj . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct zscj from " . $this->Ini->nm_tabela . " where  zscj like '%" . $zscj . "%'"; 
      ...
      { 
         while (!$rs->EOF) 
         { 
              nmgp_Form_Num_Val($rs->fields[0], $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
            $rs->MoveNext() ; 
         } 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "eval_cpresult_history.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_eval_cpresult'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_eval_cpresult/grid_eval_cpresult_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_eval_cpresult_ajax_search.js"></script>
 <script type="text/javascript" src="grid_eval_cpresult_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_zscj_cond#NMF#' + search_get_sel_txt('SC_zscj_cond') + '@NMF@';
  str_out += 'SC_zscj#NMF#' + search_get_text('SC_zscj') + '@NMF@';
  str_out += 'id_ac_zscj#NMF#' + search_get_text('id_ac_zscj') + '@NMF@';
  str_out += 'SC_zscj_input_2#NMF#' + search_get_text('SC_zscj_input_2') + '@NMF@';
   ...
   $("#id_ac_zscj").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_zscj",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_zscj").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_zscj").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_eval_cpresult'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $zscj_cond, $zscj, $zscj_input_2, $zscj_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cpbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cpbmc']; 
          $cpbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cpbmc_cond']; 
          $cgbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cgbmc']; 
          $cgbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cgbmc_cond']; 
          $cgbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cgbbh']; 
          $cgbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cgbbh_cond']; 
          $qymc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['qymc']; 
          $qymc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['qymc_cond']; 
          $zscj = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['zscj']; 
          $zscj_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['zscj_input_2']; 
          $zscj_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['zscj_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($zscj_cond) || empty($zscj_cond))
      {
         $zscj_cond = "gt";
      }
      ...
      $str_hide_zscj = (in_array($zscj_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_zscj = ('bw' == $zscj_cond) ? $display_aberto : $display_fechado;
...
<?php
   if (is_file("grid_eval_cpresult_help.txt"))
   {
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT mc, mc  FROM eval_cpb  ORDER BY id  DESC"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['psq_check_ret']['cpbmc'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['psq_check_ret']['cpbmc'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_cpbmc">
      <SELECT class="scFilterObjectOdd" id="SC_cpbmc" name="cpbmc"  size="1">
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgbmc'])) ? $this->New_label['cgbmc'] : "" . $this->Ini->Nm_lang['lang_eval_cpresult_fld_cgbmc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgbmc" name="cgbmc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgbbh'])) ? $this->New_label['cgbbh'] : "" . $this->Ini->Nm_lang['lang_eval_cpresult_fld_cgbbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cgbbh" <?php echo $str_hide_cgbbh?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cgbbh'])) ? $this->New_label['cgbbh'] : "" . $this->Ini->Nm_lang['lang_eval_cpresult_fld_cgbbh'] . "";
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cgbbh" name="cgbbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['qymc'])) ? $this->New_label['qymc'] : "" . $this->Ini->Nm_lang['lang_eval_cpresult_fld_qymc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_qymc_cond" name="qymc_cond" onChange="nm_campos_between(document.getElementById('id_vis_qymc'), this, 'qymc')">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_qymc" name="qymc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['zscj'])) ? $this->New_label['zscj'] : "" . $this->Ini->Nm_lang['lang_eval_cpresult_fld_zscj'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_zscj_cond" name="zscj_cond" onChange="nm_campos_between(document.getElementById('id_vis_zscj'), this, 'zscj')">
       <OPTION value="gt" <?php if ("gt" == $zscj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $zscj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $zscj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $zscj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_zscj" <?php echo $str_hide_zscj?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['zscj'])) ? $this->New_label['zscj'] : "" . $this->Ini->Nm_lang['lang_eval_cpresult_fld_zscj'] . "";
 $nmgp_tab_label .= "zscj?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $zscj_look = substr($this->Db->qstr($zscj), 1, -1); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct zscj from " . $this->Ini->nm_tabela . " where zscj = $zscj_look"; 
      }
      else
      {
          $nm_comando = "select distinct zscj from " . $this->Ini->nm_tabela . " where zscj = $zscj_look"; 
      ...
      if (isset($nmgp_def_dados[0][$zscj]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$zscj];
      }
      else
      {
          $sAutocompValue = $zscj;
...
?>
<INPUT  type="text" id="SC_zscj" name="zscj" value="<?php echo NM_encode_input($zscj) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_zscj" name="zscj_autocomp" size="6" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_zscj"  <?php echo $str_display_zscj; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_zscj_input_2" name="zscj_input_2" value="<?php echo NM_encode_input($zscj_input_2) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_eval_cpresult']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_eval_cpresult']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_zscj'), document.F1.zscj_cond, 'zscj');
   document.F1.zscj.value = "";
   document.F1.zscj_autocomp.value = "";
   document.F1.zscj_input_2.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "cgzb/grid_eval_cpresult";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_zscj_cond'] = 'cond';
      $tp_fields['SC_zscj'] = 'text_aut';
      $tp_fields['id_ac_zscj'] = 'text_aut';
      $tp_fields['SC_zscj_input_2'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $cpbmc_cond, $cpbmc,
             ...
             $cgbbh_cond, $cgbbh, $cgbbh_autocomp,
             $qymc_cond, $qymc, $qymc_autocomp,
             $zscj_cond, $zscj, $zscj_input_2, $zscj_autocomp, $nmgp_tab_label;
      ...
      if (!empty($zscj_autocomp) && empty($zscj))
      {
          $zscj = $zscj_autocomp;
      }
      ...
      $zscj_cond_salva = $zscj_cond; 
      if (!isset($zscj_input_2) || $zscj_input_2 == "")
      {
          $zscj_input_2 = $zscj;
      }
      $tmp_pos = strpos($cpbmc, "##@@");
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['psq_check_ret']['cpbmc'])) {
      ...
      if ($zscj_cond != "in")
      {
          nm_limpa_valor($zscj, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          if ($_SESSION['scriptcase']['reg_conf']['dec_num'] == ",")
          {
              $zscj = str_replace(" ,", ", ", $zscj);
              $Nm_sc_valores = explode(", ", $zscj);
          }
          else
          {
              $Nm_sc_valores = explode(",", $zscj);
          ...
          $zscj = implode(",", $Nm_sc_valores);
      }
      if ($zscj_cond != "in")
      {
          nm_limpa_valor($zscj_input_2, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cpbmc'] = $cpbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cpbmc_cond'] = $cpbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cgbmc'] = $cgbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cgbmc_cond'] = $cgbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cgbbh'] = $cgbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['cgbbh_cond'] = $cgbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['qymc'] = $qymc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['qymc_cond'] = $qymc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['zscj'] = $zscj; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['zscj_input_2'] = $zscj_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['zscj_cond'] = $zscj_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($zscj_cond != "in" && $zscj_cond != "bw" && !empty($zscj) && !is_numeric($zscj))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_eval_cpresult_fld_zscj'] . "";
      }
      if ($zscj_cond == "bw" && ((!empty($zscj) && !is_numeric($zscj)) || (!empty($zscj_input_2) && !is_numeric($zscj_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_eval_cpresult_fld_zscj'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['zscj'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['zscj'] = $zscj;
      }
      $Conteudo = $zscj_input_2;
      if (strtoupper($zscj_cond) != "II" && strtoupper($zscj_cond) != "QP" && strtoupper($zscj_cond) != "NP" && strtoupper($zscj_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['zscj_input_2'] = $Conteudo;

      //----- $cpbmc
      $this->Date_part = false;
      if (isset($cpbmc))
      {
         $this->monta_condicao("cpbmc", $cpbmc_cond, $cpbmc, "", "cpbmc");
      }
      ...
      //----- $zscj
      $this->Date_part = false;
      if (isset($zscj) || $zscj_cond == "nu" || $zscj_cond == "nn" || $zscj_cond == "ep" || $zscj_cond == "ne")
      {
         $this->monta_condicao("zscj", $zscj_cond, $zscj, $zscj_input_2, "zscj");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['where_pesq_ant'] = $this->comando . $this->comando_fim;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "cpbmc" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
