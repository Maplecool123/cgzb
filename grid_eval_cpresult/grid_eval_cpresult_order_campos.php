<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_eval_cpresult_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_eval_cpresult_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cpbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["cpbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["cpbmc"] : "" . $this->Nm_lang['lang_eval_cpresult_fld_cpbmc'] . "";
   $tab_ger_campos['cgbmc'] = "on";
   $tab_def_campos['cgbmc'] = "cgbmc";
   $tab_converte["cgbmc"]   = "cgbmc";
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_eval_cpresult_fld_cgbmc'] . "";
   $tab_ger_campos['qymc'] = "on";
   $tab_def_campos['qymc'] = "qymc";
   $tab_converte["qymc"]   = "qymc";
   $tab_labels["qymc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["qymc"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["qymc"] : "" . $this->Nm_lang['lang_eval_cpresult_fld_qymc'] . "";
   $tab_ger_campos['yprs'] = "on";
   $tab_def_campos['yprs'] = "yprs";
   $tab_converte["yprs"]   = "yprs";
   $tab_labels["yprs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["yprs"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["yprs"] : "" . $this->Nm_lang['lang_eval_cpresult_fld_yprs'] . "";
   $tab_ger_campos['zrs'] = "on";
   $tab_def_campos['zrs'] = "zrs";
   $tab_converte["zrs"]   = "zrs";
   $tab_labels["zrs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["zrs"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["zrs"] : "" . $this->Nm_lang['lang_eval_cpresult_fld_zrs'] . "";
   $tab_ger_campos['zscj'] = "on";
   $tab_def_campos['zscj'] = "zscj";
   $tab_converte["zscj"]   = "zscj";
   $tab_labels["zscj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["zscj"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["zscj"] : "" . $this->Nm_lang['lang_eval_cpresult_fld_zscj'] . "";
   $tab_ger_campos['evalindextj'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evalindextj'] = "evalindextj";
       $tab_converte["evalindextj"]   = "evalindextj";
   }
   else
   {
       $tab_def_campos['evalindextj'] = "";
       $tab_converte[""]   = "evalindextj";
   }
   $tab_labels["evalindextj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["evalindextj"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["evalindextj"] : "按指标统计";
   $tab_ger_campos['evalzgyj'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['evalzgyj'] = "evalzgyj";
       $tab_converte["evalzgyj"]   = "evalzgyj";
   }
   else
   {
       $tab_def_campos['evalzgyj'] = "";
       $tab_converte[""]   = "evalzgyj";
   }
   $tab_labels["evalzgyj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["evalzgyj"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['labels']["evalzgyj"] : "测评主观意见";
   $tab_ger_campos['evalindextj'] = "none";
   $tab_ger_campos['evalzgyj'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_eval_cpresult'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_eval_cpresult_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_eval_cpresult']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
