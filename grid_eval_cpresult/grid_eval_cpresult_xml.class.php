...
class grid_eval_cpresult_xml
{
   ...
   //---- 
   function grid_eval_cpresult_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_eval_cpresult.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_eval_cpresult";
...
$_SESSION['scriptcase']['grid_eval_cpresult']['contr_erro'] = 'off'; 
   ...
   function NM_export_yprs()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->yprs))
         {
             $this->yprs = sc_convert_encoding($this->yprs, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " yprs =\"" . $this->trata_dados($this->yprs) . "\"";
   }
   //----- zrs
   function NM_export_zrs()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->zrs))
         {
             $this->zrs = sc_convert_encoding($this->zrs, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " zrs =\"" . $this->trata_dados($this->zrs) . "\"";
   }
   //----- zscj
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_cpresult']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_eval_cpresult'] ?> :: XML</TITLE>
