...
<?php
include_once("form_cg_xmzjk_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_xmzjk_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['recarga'];
}
?>
...
<?php
 include_once("form_cg_xmzjk_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_xmzjk'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_xmzjk'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zbggbh_label" id="hidden_field_label_zbggbh" style="<?php echo $sStyleHidden_zbggbh; ?>"><span id="id_label_zbggbh"><?php echo $this->nm_new_label['zbggbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['zbggbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['zbggbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_zbggbh" class="sc-ui-readonly-zbggbh css_zbggbh_line" style="<?php echo $sStyleReadLab_zbggbh; ?>"><?php echo $this->form_encode_input($this->zbggbh); ?></span><span id="id_read_off_zbggbh" style="white-space: nowrap;<?php echo $sStyleReadInp_zbggbh; ?>">
 ...
 size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['zbggbh']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['zbggbh']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_zbgg"]) && $this->Ini->sc_lig_md5["grid_cg_zbgg"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,zbggbh,id*scoutnm_evt_ret_busca*scinsc_form_cg_xmzjk_zbggbh_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_xmzjk@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,zbggbh,id*scoutnm_evt_ret_busca*scinsc_form_cg_xmzjk_zbggbh_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgbbh_label" id="hidden_field_label_cgbbh" style="<?php echo $sStyleHidden_cgbbh; ?>"><span id="id_label_cgbbh"><?php echo $this->nm_new_label['cgbbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['cgbbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['cgbbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zjbh_label" id="hidden_field_label_zjbh" style="<?php echo $sStyleHidden_zjbh; ?>"><span id="id_label_zjbh"><?php echo $this->nm_new_label['zjbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['zjbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['zjbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_zjbh" class="sc-ui-readonly-zjbh css_zjbh_line" style="<?php echo $sStyleReadLab_zjbh; ?>"><?php echo $this->form_encode_input($this->zjbh); ?></span><span id="id_read_off_zjbh" style="white-space: nowrap;<?php echo $sStyleReadInp_zjbh; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_zjk"]) && $this->Ini->sc_lig_md5["grid_cg_zjk"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,zjbh,zjbh*scoutnm_evt_ret_busca*scinsc_form_cg_xmzjk_zjbh_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_xmzjk@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,zjbh,zjbh*scoutnm_evt_ret_busca*scinsc_form_cg_xmzjk_zjbh_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xm_label" id="hidden_field_label_xm" style="<?php echo $sStyleHidden_xm; ?>"><span id="id_label_xm"><?php echo $this->nm_new_label['xm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['xm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['xm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_xm_line" id="hidden_field_data_xm" style="<?php echo $sStyleHidden_xm; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xm_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="xm" value="<?php echo $this->form_encode_input($xm); ?>"><span id="id_ajax_label_xm"><?php echo nl2br($xm); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xb_label" id="hidden_field_label_xb" style="<?php echo $sStyleHidden_xb; ?>"><span id="id_label_xb"><?php echo $this->nm_new_label['xb']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['xb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['php_cmp_required']['xb'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_xb_line" id="hidden_field_data_xb" style="<?php echo $sStyleHidden_xb; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xb_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="xb" value="<?php echo $this->form_encode_input($xb); ?>"><span id="id_ajax_label_xb"><?php echo nl2br($xb); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sfzh_label" id="hidden_field_label_sfzh" style="<?php echo $sStyleHidden_sfzh; ?>"><span id="id_label_sfzh"><?php echo $this->nm_new_label['sfzh']; ?></span></TD>
    <TD class="scFormDataOdd css_sfzh_line" id="hidden_field_data_sfzh" style="<?php echo $sStyleHidden_sfzh; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sfzh_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="sfzh" value="<?php echo $this->form_encode_input($sfzh); ?>"><span id="id_ajax_label_sfzh"><?php echo nl2br($sfzh); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_gzdw_label" id="hidden_field_label_gzdw" style="<?php echo $sStyleHidden_gzdw; ?>"><span id="id_label_gzdw"><?php echo $this->nm_new_label['gzdw']; ?></span></TD>
    <TD class="scFormDataOdd css_gzdw_line" id="hidden_field_data_gzdw" style="<?php echo $sStyleHidden_gzdw; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gzdw_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="gzdw" value="<?php echo $this->form_encode_input($gzdw); ?>"><span id="id_ajax_label_gzdw"><?php echo nl2br($gzdw); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zy_line" id="hidden_field_data_zy" style="<?php echo $sStyleHidden_zy; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zy_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="zy" value="<?php echo $this->form_encode_input($zy); ?>"><span id="id_ajax_label_zy"><?php echo nl2br($zy); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_work_line" id="hidden_field_data_work" style="<?php echo $sStyleHidden_work; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_work_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="work" value="<?php echo $this->form_encode_input($work); ?>"><span id="id_ajax_label_work"><?php echo nl2br($work); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zc_line" id="hidden_field_data_zc" style="<?php echo $sStyleHidden_zc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zc_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="zc" value="<?php echo $this->form_encode_input($zc); ?>"><span id="id_ajax_label_zc"><?php echo nl2br($zc); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_yddh_line" id="hidden_field_data_yddh" style="<?php echo $sStyleHidden_yddh; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_yddh_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="yddh" value="<?php echo $this->form_encode_input($yddh); ?>"><span id="id_ajax_label_yddh"><?php echo nl2br($yddh); ?></span>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_xmzjk']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_xmzjk");
 parent.scAjaxDetailHeight("form_cg_xmzjk", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
