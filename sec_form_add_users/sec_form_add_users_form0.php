...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_add_users']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_add_users']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->form_encode_input($this->login); ?></span><span id="id_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_staff"]) && $this->Ini->sc_lig_md5["grid_cg_staff"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,login,ygbh*scoutnm_evt_ret_busca*scinsc_sec_form_add_users_login_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@sec_form_add_users@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_add_users']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,login,ygbh*scoutnm_evt_ret_busca*scinsc_sec_form_add_users_login_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_name_label" id="hidden_field_label_name" style="<?php echo $sStyleHidden_name; ?>"><span id="id_label_name"><?php echo $this->nm_new_label['name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_add_users']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_add_users']['php_cmp_required']['name'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_add_users']['Lookup_active'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_add_users']['Lookup_active'][] = 'N'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_gsmc_label" id="hidden_field_label_gsmc" style="<?php echo $sStyleHidden_gsmc; ?>"><span id="id_label_gsmc"><?php echo $this->nm_new_label['gsmc']; ?></span></TD>
