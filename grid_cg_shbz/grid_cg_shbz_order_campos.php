<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_shbz_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_shbz_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['bzmc'] = "on";
   $tab_def_campos['bzmc'] = "bzmc";
   $tab_converte["bzmc"]   = "bzmc";
   $tab_labels["bzmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["bzmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["bzmc"] : "" . $this->Nm_lang['lang_cg_shbz_fld_bzmc'] . "";
   $tab_ger_campos['isqs'] = "on";
   $tab_def_campos['isqs'] = "isqs";
   $tab_converte["isqs"]   = "isqs";
   $tab_labels["isqs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["isqs"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["isqs"] : "" . $this->Nm_lang['lang_cg_shbz_fld_isqs'] . "";
   $tab_ger_campos['isjs'] = "on";
   $tab_def_campos['isjs'] = "isjs";
   $tab_converte["isjs"]   = "isjs";
   $tab_labels["isjs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["isjs"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["isjs"] : "" . $this->Nm_lang['lang_cg_shbz_fld_isjs'] . "";
   $tab_ger_campos['yhlx'] = "on";
   $tab_def_campos['yhlx'] = "yhlx";
   $tab_converte["yhlx"]   = "yhlx";
   $tab_labels["yhlx"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["yhlx"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["yhlx"] : "" . $this->Nm_lang['lang_cg_shbz_fld_yhlx'] . "";
   $tab_ger_campos['bmlx'] = "on";
   $tab_def_campos['bmlx'] = "bmlx";
   $tab_converte["bmlx"]   = "bmlx";
   $tab_labels["bmlx"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["bmlx"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["bmlx"] : "" . $this->Nm_lang['lang_cg_shbz_fld_bmlx'] . "";
   $tab_ger_campos['isgdyh'] = "on";
   $tab_def_campos['isgdyh'] = "isgdyh";
   $tab_converte["isgdyh"]   = "isgdyh";
   $tab_labels["isgdyh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["isgdyh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["isgdyh"] : "" . $this->Nm_lang['lang_cg_shbz_fld_isgdyh'] . "";
   $tab_ger_campos['gdyh'] = "on";
   $tab_def_campos['gdyh'] = "gdyh";
   $tab_converte["gdyh"]   = "gdyh";
   $tab_labels["gdyh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["gdyh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["gdyh"] : "" . $this->Nm_lang['lang_cg_shbz_fld_gdyh'] . "";
   $tab_ger_campos['listorder'] = "on";
   $tab_def_campos['listorder'] = "listorder";
   $tab_converte["listorder"]   = "listorder";
   $tab_labels["listorder"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["listorder"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['labels']["listorder"] : "" . $this->Nm_lang['lang_cg_shbz_fld_listorder'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_shbz'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_shbz_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_shbz']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
