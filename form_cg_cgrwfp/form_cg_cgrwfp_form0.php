...
<?php
include_once("form_cg_cgrwfp_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_cgrwfp_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['recarga'];
}
?>
...
<?php
 include_once("form_cg_cgrwfp_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_cgrwfp'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_cgrwfp'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgbbh_label" id="hidden_field_label_cgbbh" style="<?php echo $sStyleHidden_cgbbh; ?>"><span id="id_label_cgbbh"><?php echo $this->nm_new_label['cgbbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgbbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgbbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_cgbbh" class="sc-ui-readonly-cgbbh css_cgbbh_line" style="<?php echo $sStyleReadLab_cgbbh; ?>"><?php echo $this->form_encode_input($this->cgbbh); ?></span><span id="id_read_off_cgbbh" style="white-space: nowrap;<?php echo $sStyleReadInp_cgbbh; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_cgb"]) && $this->Ini->sc_lig_md5["grid_cg_cgb"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,cgbbh,b_cgbbh*scoutnm_evt_ret_busca*scinsc_form_cg_cgrwfp_cgbbh_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_cgrwfp@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,cgbbh,b_cgbbh*scoutnm_evt_ret_busca*scinsc_form_cg_cgrwfp_cgbbh_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgys_label" id="hidden_field_label_cgys" style="<?php echo $sStyleHidden_cgys; ?>"><span id="id_label_cgys"><?php echo $this->nm_new_label['cgys']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgys']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgys'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cgys_line" id="hidden_field_data_cgys" style="<?php echo $sStyleHidden_cgys; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgys_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="cgys" value="<?php echo $this->form_encode_input($cgys); ?>"><span id="id_ajax_label_cgys"><?php echo nl2br($cgys); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgfs_label" id="hidden_field_label_cgfs" style="<?php echo $sStyleHidden_cgfs; ?>"><span id="id_label_cgfs"><?php echo $this->nm_new_label['cgfs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgfs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgfs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgybh_label" id="hidden_field_label_cgybh" style="<?php echo $sStyleHidden_cgybh; ?>"><span id="id_label_cgybh"><?php echo $this->nm_new_label['cgybh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgybh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgybh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_cgybh" class="sc-ui-readonly-cgybh css_cgybh_line" style="<?php echo $sStyleReadLab_cgybh; ?>"><?php echo $this->form_encode_input($this->cgybh); ?></span><span id="id_read_off_cgybh" style="white-space: nowrap;<?php echo $sStyleReadInp_cgybh; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_cgy"]) && $this->Ini->sc_lig_md5["grid_cg_cgy"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,cgybh,ygbh*scoutnm_evt_ret_busca*scinsc_form_cg_cgrwfp_cgybh_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_cgrwfp@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,cgybh,ygbh*scoutnm_evt_ret_busca*scinsc_form_cg_cgrwfp_cgybh_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgyxm_label" id="hidden_field_label_cgyxm" style="<?php echo $sStyleHidden_cgyxm; ?>"><span id="id_label_cgyxm"><?php echo $this->nm_new_label['cgyxm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgyxm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgyxm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cgyxm_line" id="hidden_field_data_cgyxm" style="<?php echo $sStyleHidden_cgyxm; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgyxm_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="cgyxm" value="<?php echo $this->form_encode_input($cgyxm); ?>"><span id="id_ajax_label_cgyxm"><?php echo nl2br($cgyxm); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgylxdh_label" id="hidden_field_label_cgylxdh" style="<?php echo $sStyleHidden_cgylxdh; ?>"><span id="id_label_cgylxdh"><?php echo $this->nm_new_label['cgylxdh']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgzt_label" id="hidden_field_label_cgzt" style="<?php echo $sStyleHidden_cgzt; ?>"><span id="id_label_cgzt"><?php echo $this->nm_new_label['cgzt']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgzt']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['php_cmp_required']['cgzt'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cgzt_line" id="hidden_field_data_cgzt" style="<?php echo $sStyleHidden_cgzt; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgzt_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_cgrwfp']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_cgrwfp");
 parent.scAjaxDetailHeight("form_cg_cgrwfp", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
