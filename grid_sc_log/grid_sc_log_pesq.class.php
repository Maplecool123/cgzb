...
class grid_sc_log_pesq
{
    ...
    * @access  public
    */
   function grid_sc_log_pesq()
   {
      $this->inserted_date_opc_bi[] = "TP";
      $this->inserted_date_opc_bi[] = "HJ";
      $this->inserted_date_opc_bi[] = "OT";
      $this->inserted_date_opc_bi[] = "U7";
      $this->inserted_date_opc_bi[] = "SP";
      $this->inserted_date_opc_bi[] = "US";
      $this->inserted_date_opc_bi[] = "MM";
      $this->inserted_date_opc_bi[] = "UM";
      $this->inserted_date_opc_bi[] = "CY";
      $this->inserted_date_opc_bi[] = "LY";
      $this->inserted_date_opc_bi[] = "M24";
      $this->inserted_date_opc_bi[] = "M18";
      $this->inserted_date_opc_bi[] = "YY";
      $this->inserted_date_opc_bi[] = "M6";
      $this->inserted_date_opc_bi[] = "M3";
   }
...
//-- ajax metodos ---
   ...
   function lookup_ajax_username($username)
   {
      ...
      $nm_comando = "select distinct username from " . $this->Ini->nm_tabela . " where  username like '%" . $username . "%'"; 
   ...
   function lookup_ajax_application($application)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct application from " . $this->Ini->nm_tabela . " where  application like '%" . $application . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_ip_user($ip_user)
   {
      $ip_user = substr($this->Db->qstr($ip_user), 1, -1);
            $ip_user_look = substr($this->Db->qstr($ip_user), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ip_user from " . $this->Ini->nm_tabela . " where  ip_user like '%" . $ip_user . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_sc_field_0($sc_field_0)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct `action` from " . $this->Ini->nm_tabela . " where  `action` like '%" . $sc_field_0 . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_sc_log'] ?></TITLE>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_sc_log'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $ip_user = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['ip_user']; 
          $ip_user_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['ip_user_cond']; 
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['sc_field_0_cond']; 
      ...
      if (isset($inserted_date_cond) && in_array($inserted_date_cond, $this->inserted_date_opc_bi))
      {
         ...
         $inserted_date_ano = substr($BI_data1, 4);
         $inserted_date_input_2_dia = substr($BI_data2, 0, 2);
         $inserted_date_input_2_mes = substr($BI_data2, 2, 2);
         $inserted_date_input_2_ano = substr($BI_data2, 4);
         $Script_BI .= "  formata_bi_inserted_date('" . $inserted_date_cond . "');\r\n";
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['inserted_date'])) ? $this->New_label['inserted_date'] : "" . $this->Ini->Nm_lang['lang_sc_log_fld_inserted_date'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_inserted_date_cond" name="inserted_date_cond" onChange="nm_campos_between(document.getElementById('id_vis_inserted_date'), this, 'inserted_date')">
       ...
       <OPTION value="TP" <?php if ("TP" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_ever'] ?></OPTION>
       <OPTION value="HJ" <?php if ("HJ" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="OT" <?php if ("OT" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="U7" <?php if ("U7" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lst7'] ?></OPTION>
       <OPTION value="SP" <?php if ("SP" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw'] ?></OPTION>
       <OPTION value="US" <?php if ("US" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw_bsnd'] ?></OPTION>
       <OPTION value="MM" <?php if ("MM" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_this_mnth'] ?></OPTION>
       <OPTION value="UM" <?php if ("UM" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="CY" <?php if ("CY" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_curr_year'] ?></OPTION>
       <OPTION value="LY" <?php if ("LY" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="M24" <?php if ("M24" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_24mo'] ?></OPTION>
       <OPTION value="M18" <?php if ("M18" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_18mo'] ?></OPTION>
       <OPTION value="YY" <?php if ("YY" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_12mo'] ?></OPTION>
       <OPTION value="M6" <?php if ("M6" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_06mo'] ?></OPTION>
       <OPTION value="M3" <?php if ("M3" == $inserted_date_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_dia" name="inserted_date_dia" value="<?php echo NM_encode_input($inserted_date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.inserted_date_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_inserted_date_mes" name="inserted_date_mes" value="<?php echo NM_encode_input($inserted_date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.inserted_date_cond.value)">
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['username'])) ? $this->New_label['username'] : "" . $this->Ini->Nm_lang['lang_sc_log_fld_username'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
      $username_look = substr($this->Db->qstr($username), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct username from " . $this->Ini->nm_tabela . " where username = '$username_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_username" name="username" value="<?php echo NM_encode_input($username) ?>" size=32 alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_username" name="username_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['application'])) ? $this->New_label['application'] : "" . $this->Ini->Nm_lang['lang_sc_log_fld_application'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      $application_look = substr($this->Db->qstr($application), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct application from " . $this->Ini->nm_tabela . " where application = '$application_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_application" name="application" value="<?php echo NM_encode_input($application) ?>" size=32 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_application" name="application_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['ip_user'])) ? $this->New_label['ip_user'] : "" . $this->Ini->Nm_lang['lang_sc_log_fld_ip_user'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
      $ip_user_look = substr($this->Db->qstr($ip_user), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ip_user from " . $this->Ini->nm_tabela . " where ip_user = '$ip_user_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ip_user" name="ip_user_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "" . $this->Ini->Nm_lang['lang_sc_log_fld_action'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      $sc_field_0_look = substr($this->Db->qstr($sc_field_0), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct `action` from " . $this->Ini->nm_tabela . " where `action` = '$sc_field_0_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sc_field_0" name="sc_field_0_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
 ...
 function limpa_form()
 {
   ...
   var opc_bi = document.F1.inserted_date_cond.value;
   ...
   {
       document.F1.inserted_date_cond.value = 'TP';
   }
...
function formata_bi_inserted_date(opc)
{
   if (opc != "TP" && opc != "HJ" && opc != "OT" && opc != "U7" && opc != "SP" && opc != "US" && opc != "MM" && opc != "UM" && opc != "AM" && opc != "PS" && opc != "SS" && opc != "P3" && opc != "PM" && opc != "P7" && opc != "CY" && opc != "LY" && opc != "YY" && opc != "M6" && opc != "M3" && opc != "M18" && opc != "M24")
   {
...
<?php
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['ip_user'] = $ip_user; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['ip_user_cond'] = $ip_user_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['sc_field_0'] = $sc_field_0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      ...
      {
         $this->monta_condicao("ip_user", $ip_user_cond, $ip_user, "", "ip_user");
      }
      ...
      {
         $this->monta_condicao("`action`", $sc_field_0_cond, $sc_field_0, "", "sc_field_0");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sc_log']['where_pesq_ant'] = $this->comando . $this->comando_fim;
