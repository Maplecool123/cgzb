...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["inserted_date"]   = "inserted_date";
   $tab_labels["inserted_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["inserted_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["inserted_date"] : "" . $this->Nm_lang['lang_sc_log_fld_inserted_date'] . "";
   $tab_ger_campos['username'] = "on";
   $tab_def_campos['username'] = "username";
   $tab_converte["username"]   = "username";
   $tab_labels["username"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["username"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["username"] : "" . $this->Nm_lang['lang_sc_log_fld_username'] . "";
   $tab_ger_campos['application'] = "on";
   $tab_def_campos['application'] = "application";
   $tab_converte["application"]   = "application";
   $tab_labels["application"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["application"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["application"] : "" . $this->Nm_lang['lang_sc_log_fld_application'] . "";
   $tab_ger_campos['ip_user'] = "on";
   $tab_def_campos['ip_user'] = "ip_user";
   $tab_converte["ip_user"]   = "ip_user";
   $tab_labels["ip_user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["ip_user"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["ip_user"] : "" . $this->Nm_lang['lang_sc_log_fld_ip_user'] . "";
   ...
   else
   {
       ...
       $tab_converte["`action`"]   = "sc_field_0";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_sc_log']['labels']["sc_field_0"] : "" . $this->Nm_lang['lang_sc_log_fld_action'] . "";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_sc_log']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_sc_log'] ?></TITLE>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_sc_log']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_sc_log']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
