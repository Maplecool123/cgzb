...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $Nm_lang['lang_tbl_sc_log'] ?> :: PDF</title>
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_sc_log'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
