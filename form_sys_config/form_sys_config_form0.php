...
<?php
include_once("form_sys_config_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_sys_config_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['recarga'];
}
?>
...
<?php
 include_once("form_sys_config_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_sys_config'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_sys_config'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_t", "", "提交保存", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sys_name_label" id="hidden_field_label_sys_name" style="<?php echo $sStyleHidden_sys_name; ?>"><span id="id_label_sys_name"><?php echo $this->nm_new_label['sys_name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['sys_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['sys_name'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sys_name_line" id="hidden_field_data_sys_name" style="<?php echo $sStyleHidden_sys_name; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sys_name_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sys_demo_label" id="hidden_field_label_sys_demo" style="<?php echo $sStyleHidden_sys_demo; ?>"><span id="id_label_sys_demo"><?php echo $this->nm_new_label['sys_demo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['sys_demo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['sys_demo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sys_demo_line" id="hidden_field_data_sys_demo" style="<?php echo $sStyleHidden_sys_demo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sys_demo_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['Lookup_sys_demo'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['Lookup_sys_demo'][] = 'N'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sys_theme_label" id="hidden_field_label_sys_theme" style="<?php echo $sStyleHidden_sys_theme; ?>"><span id="id_label_sys_theme"><?php echo $this->nm_new_label['sys_theme']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['sys_theme']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['sys_theme'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sys_theme_line" id="hidden_field_data_sys_theme" style="<?php echo $sStyleHidden_sys_theme; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sys_theme_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_demo_accounts_label" id="hidden_field_label_demo_accounts" style="<?php echo $sStyleHidden_demo_accounts; ?>"><span id="id_label_demo_accounts"><?php echo $this->nm_new_label['demo_accounts']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['demo_accounts']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['demo_accounts'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_demo_accounts_line" id="hidden_field_data_demo_accounts" style="<?php echo $sStyleHidden_demo_accounts; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_demo_accounts_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_smtp_server_label" id="hidden_field_label_mail_smtp_server" style="<?php echo $sStyleHidden_mail_smtp_server; ?>"><span id="id_label_mail_smtp_server"><?php echo $this->nm_new_label['mail_smtp_server']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['mail_smtp_server']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['mail_smtp_server'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_mail_smtp_server_line" id="hidden_field_data_mail_smtp_server" style="<?php echo $sStyleHidden_mail_smtp_server; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mail_smtp_server_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_smtp_user_label" id="hidden_field_label_mail_smtp_user" style="<?php echo $sStyleHidden_mail_smtp_user; ?>"><span id="id_label_mail_smtp_user"><?php echo $this->nm_new_label['mail_smtp_user']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['mail_smtp_user']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['mail_smtp_user'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_mail_smtp_user_line" id="hidden_field_data_mail_smtp_user" style="<?php echo $sStyleHidden_mail_smtp_user; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mail_smtp_user_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_smtp_pass_label" id="hidden_field_label_mail_smtp_pass" style="<?php echo $sStyleHidden_mail_smtp_pass; ?>"><span id="id_label_mail_smtp_pass"><?php echo $this->nm_new_label['mail_smtp_pass']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['mail_smtp_pass']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['mail_smtp_pass'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_mail_smtp_pass_line" id="hidden_field_data_mail_smtp_pass" style="<?php echo $sStyleHidden_mail_smtp_pass; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mail_smtp_pass_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_from_email_label" id="hidden_field_label_mail_from_email" style="<?php echo $sStyleHidden_mail_from_email; ?>"><span id="id_label_mail_from_email"><?php echo $this->nm_new_label['mail_from_email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['mail_from_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['php_cmp_required']['mail_from_email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_mail_from_email_line" id="hidden_field_data_mail_from_email" style="<?php echo $sStyleHidden_mail_from_email; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mail_from_email_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sys_config']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_sys_config");
 parent.scAjaxDetailHeight("form_sys_config", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
