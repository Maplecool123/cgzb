<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_lxgl_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_lxgl_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["xmbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["xmbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["xmbh"] : "" . $this->Nm_lang['lang_cg_lxgl_fld_xmbh'] . "";
   $tab_ger_campos['xmmc'] = "on";
   $tab_def_campos['xmmc'] = "xmmc";
   $tab_converte["xmmc"]   = "xmmc";
   $tab_labels["xmmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["xmmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["xmmc"] : "" . $this->Nm_lang['lang_cg_lxgl_fld_xmmc'] . "";
   $tab_ger_campos['ysje'] = "on";
   $tab_def_campos['ysje'] = "ysje";
   $tab_converte["ysje"]   = "ysje";
   $tab_labels["ysje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["ysje"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["ysje"] : "" . $this->Nm_lang['lang_cg_lxgl_fld_ysje'] . "";
   $tab_ger_campos['zjly'] = "on";
   $tab_def_campos['zjly'] = "zjly";
   $tab_converte["zjly"]   = "zjly";
   $tab_labels["zjly"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["zjly"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["zjly"] : "" . $this->Nm_lang['lang_cg_lxgl_fld_zjly'] . "";
   $tab_ger_campos['xmfzr'] = "on";
   $tab_def_campos['xmfzr'] = "xmfzr";
   $tab_converte["xmfzr"]   = "xmfzr";
   $tab_labels["xmfzr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["xmfzr"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["xmfzr"] : "" . $this->Nm_lang['lang_cg_lxgl_fld_xmfzr'] . "";
   $tab_ger_campos['sbbm'] = "on";
   $tab_def_campos['sbbm'] = "sbbm";
   $tab_converte["sbbm"]   = "sbbm";
   $tab_labels["sbbm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["sbbm"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["sbbm"] : "" . $this->Nm_lang['lang_cg_lxgl_fld_sbbm'] . "";
   $tab_ger_campos['sbrq'] = "on";
   $tab_def_campos['sbrq'] = "sbrq";
   $tab_converte["sbrq"]   = "sbrq";
   $tab_labels["sbrq"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["sbrq"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["sbrq"] : "" . $this->Nm_lang['lang_cg_lxgl_fld_sbrq'] . "";
   $tab_ger_campos['shzt'] = "on";
   $tab_def_campos['shzt'] = "shzt";
   $tab_converte["shzt"]   = "shzt";
   $tab_labels["shzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["shzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["shzt"] : "" . $this->Nm_lang['lang_cg_lxgl_fld_shzt'] . "";
   ...
   $tab_labels["splc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["splc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["splc"] : "操作";
   ...
   $tab_labels["splcxx"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["splcxx"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['labels']["splcxx"] : "审批信息";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_lxgl'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_lxgl_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_lxgl']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
