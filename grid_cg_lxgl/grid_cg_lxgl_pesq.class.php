...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_lxgl'] ?></TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['xmbh'])) ? $this->New_label['xmbh'] : "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_xmbh" name="xmbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['xmmc'])) ? $this->New_label['xmmc'] : "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmmc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_xmmc" name="xmmc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['xmfzr'])) ? $this->New_label['xmfzr'] : "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmfzr'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_xmfzr" name="xmfzr_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['zjly'])) ? $this->New_label['zjly'] : "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_zjly'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['sbbm'])) ? $this->New_label['sbbm'] : "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbbm'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['sbrq'])) ? $this->New_label['sbrq'] : "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbrq'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['shzt'])) ? $this->New_label['shzt'] : "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_shzt'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
