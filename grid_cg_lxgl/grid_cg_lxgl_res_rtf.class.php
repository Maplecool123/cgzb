...
class grid_cg_lxgl_res_rtf
{
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['arr_export']['data'];
       $b_display = false;
