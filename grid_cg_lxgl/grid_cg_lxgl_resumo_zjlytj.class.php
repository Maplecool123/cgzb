...
class grid_cg_lxgl_resumo
{
   ...
   //---- 
   function grid_cg_lxgl_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['contr_total_geral'] == "OK")
      {
          $this->array_total_zjly = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['arr_total']['zjly'];
      }
      else
      {
          $this->array_total_zjly = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['arr_total']['zjly'] = $this->array_total_zjly;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $this->comp_field = array(
           "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_zjly'] . "",
       );
       ...
       $this->comp_sum = array(
           ...
           2 => "" .  $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . "(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['summarizing_fields_control'] = array(
               'NM_Count' => array(
               ...
               'ysje' => array(
                   'label' => "" .  $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . "(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . "",
                   'options' => array(
                       array('op' => 'S', 'index' => '2', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-ysje\" onChange=\"scSummChange($(this))\"><option value=\"2\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
       }
       //-----
       ...
       //-----
       foreach ($this->array_total_zjly as $i_zjly => $d_zjly) {
           if (!in_array($i_zjly, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_zjly[3] ] = $d_zjly[2];
               $this->comp_label[0][ $d_zjly[3] ] = $d_zjly[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_zjly => $l_zjly) {
           if (isset($this->array_total_zjly[$i_zjly])) {
               $this->comp_group[$i_zjly] = array();
           }
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_zjly'] . "")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . "(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_zjly'] . "")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . "(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_cg_lxgl_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_cg_lxgl_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_cg_lxgl_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] = "print";
      ...
      $this->total   = new grid_cg_lxgl_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_zjlytj("res", $this->array_total_zjly);
      ksort($this->array_total_zjly);
      if ("out" == $this->NM_tipo)
      {
         $this->total->quebra_geral();
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cg_lxgl_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_cg_lxgl_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cg_lxgl_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_cg_lxgl/grid_cg_lxgl_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['embutida'])
      {
         ...
         if (is_file("grid_cg_lxgl_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cg_lxgl/grid_cg_lxgl_config_graf_flash.php?nome_apl=grid_cg_lxgl&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=zh_cn&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         $nm_saida->saida("     </TD> \r\n");
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cg_lxgl/grid_cg_lxgl_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=zh_cn&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cg_lxgl/grid_cg_lxgl_config_word.php?nm_cor=AM&language=zh_cn&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cg_lxgl/grid_cg_lxgl_config_print.php?nm_opc=resumo&nm_cor=AM&language=zh_cn&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_cg_lxgl_config_pivot.php?nome_apl=grid_cg_lxgl&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=zh_cn&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_cg_lxgl/grid_cg_lxgl_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cg_lxgl_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_cg_lxgl/grid_cg_lxgl_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_lxgl']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $xmbh = $Busca_temp['xmbh']; 
          $tmp_pos = strpos($xmbh, "##@@");
          if ($tmp_pos !== false)
          {
              $xmbh = substr($xmbh, 0, $tmp_pos);
          }
          $xmmc = $Busca_temp['xmmc']; 
          $tmp_pos = strpos($xmmc, "##@@");
          if ($tmp_pos !== false)
          {
              $xmmc = substr($xmmc, 0, $tmp_pos);
          }
          $xmfzr = $Busca_temp['xmfzr']; 
          $tmp_pos = strpos($xmfzr, "##@@");
          if ($tmp_pos !== false)
          {
              $xmfzr = substr($xmfzr, 0, $tmp_pos);
          }
          $zjly = $Busca_temp['zjly']; 
          $tmp_pos = strpos($zjly, "##@@");
          if ($tmp_pos !== false)
          {
              $zjly = substr($zjly, 0, $tmp_pos);
          }
          $sbbm = $Busca_temp['sbbm']; 
          $tmp_pos = strpos($sbbm, "##@@");
          if ($tmp_pos !== false)
          {
              $sbbm = substr($sbbm, 0, $tmp_pos);
          }
          $sbrq = $Busca_temp['sbrq']; 
          $tmp_pos = strpos($sbrq, "##@@");
          if ($tmp_pos !== false)
          {
   ...
   //---- 
   function adiciona_registro($sum_ysje, $quebra_zjly, $quebra_zjly_orig)
   {
      //----- zjly
      if (!isset($this->array_total_zjly[$quebra_zjly_orig]))
      {
         $this->array_total_zjly[$quebra_zjly_orig][0] = 1;
         $this->array_total_zjly[$quebra_zjly_orig][1] = $sum_ysje;
         $this->array_total_zjly[$quebra_zjly_orig][2] = $quebra_zjly;
         $this->array_total_zjly[$quebra_zjly_orig][3] = $quebra_zjly_orig;
      }
      else
      {
         $this->array_total_zjly[$quebra_zjly_orig][0]++;
         $this->array_total_zjly[$quebra_zjly_orig][1] += $sum_ysje;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->xmbh = $rs_res->fields[0] ;  
            $this->xmmc = $rs_res->fields[1] ;  
            $this->ysje = $rs_res->fields[2] ;  
            $this->ysje =  str_replace(",", ".", $this->ysje);
            $this->zjly = $rs_res->fields[3] ;  
            $this->xmfzr = $rs_res->fields[4] ;  
            $this->sbbm = $rs_res->fields[5] ;  
            $this->sbrq = $rs_res->fields[6] ;  
            $this->shzt = $rs_res->fields[7] ;  
            $this->ysly = $rs_res->fields[8] ;  
            $this->sbr = $rs_res->fields[9] ;  
            $this->qwcgrq = $rs_res->fields[10] ;  
            $this->lxr = $rs_res->fields[11] ;  
            $this->lxdh = $rs_res->fields[12] ;  
            $this->email = $rs_res->fields[13] ;  
            $this->cjsj = $rs_res->fields[14] ;  
            $this->id = $rs_res->fields[15] ;  
            $this->zjly_orig = $this->zjly;
...
$_SESSION['scriptcase']['grid_cg_lxgl']['contr_erro'] = 'off'; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->ysje, $this->zjly, $this->zjly_orig);
            }
   }
//
