...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_gsmc' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_gsmc_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_sec_form_edit_users_gsmc_onfocus(this, iSeqRow) });
...
function sc_sec_form_edit_users_gsmc_onblur(oThis, iSeqRow) {
  do_ajax_sec_form_edit_users_mob_validate_gsmc();
  scCssBlur(oThis);
}

function sc_sec_form_edit_users_gsmc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
