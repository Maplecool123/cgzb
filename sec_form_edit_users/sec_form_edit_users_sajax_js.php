...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate gsmc
  function do_ajax_sec_form_edit_users_validate_gsmc()
  {
    var nomeCampo_gsmc = "gsmc";
    var var_gsmc = scAjaxGetFieldText(nomeCampo_gsmc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_gsmc(var_gsmc, var_script_case_init, do_ajax_sec_form_edit_users_validate_gsmc_cb);
  } // do_ajax_sec_form_edit_users_validate_gsmc

  function do_ajax_sec_form_edit_users_validate_gsmc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "gsmc";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_gsmc_cb
  // ---------- Form
  function do_ajax_sec_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_form_edit_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_gsmc, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_form_edit_users_submit_form_cb);
