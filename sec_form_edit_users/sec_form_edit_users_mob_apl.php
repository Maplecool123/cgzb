...
//----- 
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_users'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['sec_form_edit_users_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
//---------------------------------------------------------
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['php_cmp_required']['name'] == "on")) 
      { 
          if ($this->name == "")  
          { 
    ...
    {
        global $teste_validade;
                  if ($this->groups != "" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_groups']) && !in_array($this->groups, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_groups']))
                  {
                      $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(sec_form_edit_users_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => sec_form_edit_users_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan'])
   {
