<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_xmzjk_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_xmzjk_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cgbbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["cgbbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["cgbbh"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_cgbbh'] . "";
   $tab_ger_campos['cgbmc'] = "on";
   $tab_def_campos['cgbmc'] = "cgbmc";
   $tab_converte["cgbmc"]   = "cgbmc";
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_cgbmc'] . "";
   $tab_ger_campos['zjbh'] = "on";
   $tab_def_campos['zjbh'] = "zjbh";
   $tab_converte["zjbh"]   = "zjbh";
   $tab_labels["zjbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["zjbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["zjbh"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_zjbh'] . "";
   $tab_ger_campos['xm'] = "on";
   $tab_def_campos['xm'] = "xm";
   $tab_converte["xm"]   = "xm";
   $tab_labels["xm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["xm"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["xm"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_xm'] . "";
   $tab_ger_campos['xb'] = "on";
   $tab_def_campos['xb'] = "xb";
   $tab_converte["xb"]   = "xb";
   $tab_labels["xb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["xb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["xb"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_xb'] . "";
   $tab_ger_campos['zc'] = "on";
   $tab_def_campos['zc'] = "zc";
   $tab_converte["zc"]   = "zc";
   $tab_labels["zc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["zc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["zc"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_zc'] . "";
   $tab_ger_campos['yddh'] = "on";
   $tab_def_campos['yddh'] = "yddh";
   $tab_converte["yddh"]   = "yddh";
   $tab_labels["yddh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["yddh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["yddh"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_yddh'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['labels']["email"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_email'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_xmzjk_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
