  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cg_shlc" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate lcbh
  function do_ajax_form_cg_shlc_validate_lcbh()
  {
    var nomeCampo_lcbh = "lcbh";
    var var_lcbh = scAjaxGetFieldText(nomeCampo_lcbh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_shlc_validate_lcbh(var_lcbh, var_script_case_init, do_ajax_form_cg_shlc_validate_lcbh_cb);
  } // do_ajax_form_cg_shlc_validate_lcbh

  function do_ajax_form_cg_shlc_validate_lcbh_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_shlc_validate_lcbh_cb

  // ---------- Validate lcmc
  function do_ajax_form_cg_shlc_validate_lcmc()
  {
    var nomeCampo_lcmc = "lcmc";
    var var_lcmc = scAjaxGetFieldText(nomeCampo_lcmc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_shlc_validate_lcmc(var_lcmc, var_script_case_init, do_ajax_form_cg_shlc_validate_lcmc_cb);
  } // do_ajax_form_cg_shlc_validate_lcmc

  function do_ajax_form_cg_shlc_validate_lcmc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lcmc";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_shlc_validate_lcmc_cb
  // ---------- Form
  function do_ajax_form_cg_shlc_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cg_shlc_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cg_shlc_submit_form(var_lcbh, var_lcmc, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cg_shlc_submit_form_cb);
  } // do_ajax_form_cg_shlc_submit_form

  function do_ajax_form_cg_shlc_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cg_shlc_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cg_shlc_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cg_shlc_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cg_shlc_navigate_form_cb);
  } // do_ajax_form_cg_shlc_navigate_form

  function do_ajax_form_cg_shlc_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_cg_shlc_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cg_shlc_navigate_form_cb
  function sc_hide_form_cg_shlc_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_cg_shlc_form
