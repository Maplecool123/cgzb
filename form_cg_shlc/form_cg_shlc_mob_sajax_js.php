  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cg_shlc_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate lcbh
  function do_ajax_form_cg_shlc_mob_validate_lcbh()
  {
    var nomeCampo_lcbh = "lcbh";
    var var_lcbh = scAjaxGetFieldText(nomeCampo_lcbh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_shlc_mob_validate_lcbh(var_lcbh, var_script_case_init, do_ajax_form_cg_shlc_mob_validate_lcbh_cb);
  } // do_ajax_form_cg_shlc_mob_validate_lcbh

  function do_ajax_form_cg_shlc_mob_validate_lcbh_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_shlc_mob_validate_lcbh_cb

  // ---------- Validate lcmc
  function do_ajax_form_cg_shlc_mob_validate_lcmc()
  {
    var nomeCampo_lcmc = "lcmc";
    var var_lcmc = scAjaxGetFieldText(nomeCampo_lcmc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_shlc_mob_validate_lcmc(var_lcmc, var_script_case_init, do_ajax_form_cg_shlc_mob_validate_lcmc_cb);
  } // do_ajax_form_cg_shlc_mob_validate_lcmc

  function do_ajax_form_cg_shlc_mob_validate_lcmc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lcmc";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_shlc_mob_validate_lcmc_cb
  // ---------- Form
  function do_ajax_form_cg_shlc_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cg_shlc_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_lcbh = scAjaxGetFieldText("lcbh");
    var var_lcmc = scAjaxGetFieldText("lcmc");
    ...
    scAjaxProcOn();
    x_ajax_form_cg_shlc_mob_submit_form(var_lcbh, var_lcmc, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cg_shlc_mob_submit_form_cb);
  } // do_ajax_form_cg_shlc_mob_submit_form

  function do_ajax_form_cg_shlc_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("lcbh");
      scAjaxHideErrorDisplay("lcmc");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_cg_shlc_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cg_shlc_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cg_shlc_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cg_shlc_mob_navigate_form_cb);
  } // do_ajax_form_cg_shlc_mob_navigate_form

  function do_ajax_form_cg_shlc_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_cg_shlc_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cg_shlc_mob_navigate_form_cb
  function sc_hide_form_cg_shlc_mob_form()
  {
  ...
  ajax_field_list[0] = "lcbh";
  ajax_field_list[1] = "lcmc";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "lcbh": {"label": "<?php echo $this->Ini->Nm_lang['lang_cg_shlc_fld_lcbh'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lcmc": {"label": "<?php echo $this->Ini->Nm_lang['lang_cg_shlc_fld_lcmc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["lcbh"][1] = "lcbh";
  ajax_field_mult["lcmc"][1] = "lcmc";

  var ajax_field_id = {
    "lcbh": new Array("hidden_field_label_lcbh", "hidden_field_data_lcbh"),
    "lcmc": new Array("hidden_field_label_lcmc", "hidden_field_data_lcmc")
  };
