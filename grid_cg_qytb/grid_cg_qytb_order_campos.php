<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_qytb_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_qytb_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cgbbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["cgbbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["cgbbh"] : "" . $this->Nm_lang['lang_cg_qytb_fld_cgbbh'] . "";
   $tab_ger_campos['cgbmc'] = "on";
   $tab_def_campos['cgbmc'] = "cgbmc";
   $tab_converte["cgbmc"]   = "cgbmc";
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_cg_qytb_fld_cgbmc'] . "";
   $tab_ger_campos['bj'] = "on";
   $tab_def_campos['bj'] = "bj";
   $tab_converte["bj"]   = "bj";
   $tab_labels["bj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["bj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["bj"] : "" . $this->Nm_lang['lang_cg_qytb_fld_bj'] . "";
   $tab_ger_campos['jsfile'] = "on";
   $tab_def_campos['jsfile'] = "jsfile";
   $tab_converte["jsfile"]   = "jsfile";
   $tab_labels["jsfile"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["jsfile"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["jsfile"] : "" . $this->Nm_lang['lang_cg_qytb_fld_jsfile'] . "";
   $tab_ger_campos['swfile'] = "on";
   $tab_def_campos['swfile'] = "swfile";
   $tab_converte["swfile"]   = "swfile";
   $tab_labels["swfile"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["swfile"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["swfile"] : "" . $this->Nm_lang['lang_cg_qytb_fld_swfile'] . "";
   $tab_ger_campos['qtfile'] = "on";
   $tab_def_campos['qtfile'] = "qtfile";
   $tab_converte["qtfile"]   = "qtfile";
   $tab_labels["qtfile"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["qtfile"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["qtfile"] : "" . $this->Nm_lang['lang_cg_qytb_fld_qtfile'] . "";
   $tab_ger_campos['tjsj'] = "on";
   $tab_def_campos['tjsj'] = "tjsj";
   $tab_converte["tjsj"]   = "tjsj";
   $tab_labels["tjsj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["tjsj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['labels']["tjsj"] : "" . $this->Nm_lang['lang_cg_qytb_fld_tjsj'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_qytb'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_qytb_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_qytb']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
