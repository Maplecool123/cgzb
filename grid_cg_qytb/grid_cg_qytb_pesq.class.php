...
class grid_cg_qytb_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_qytb_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_qytb_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_qytb_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_qytb'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_qytb/grid_cg_qytb_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_qytb_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_qytb_ajax.js"></script>
 <script type="text/javascript">
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_qytb'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cgbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['cgbmc']; 
          $cgbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['cgbmc_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['id']; 
          $id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['id_input_2']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['id_cond']; 
          $zbggbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['zbggbh']; 
          $zbggbh_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['zbggbh_input_2']; 
          $zbggbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['zbggbh_cond']; 
          $cgbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['cgbbh']; 
          $cgbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['cgbbh_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_cg_qytb_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_qytb']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_qytb']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      global $cgbmc_cond, $cgbmc, $cgbmc_autocomp,
             $id_cond, $id, $id_input_2, $id_autocomp,
             $zbggbh_cond, $zbggbh, $zbggbh_input_2, $zbggbh_autocomp,
             $cgbbh_cond, $cgbbh, $cgbbh_autocomp, $nmgp_tab_label;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['cgbmc'] = $cgbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['cgbmc_cond'] = $cgbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['id_input_2'] = $id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['zbggbh'] = $zbggbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['zbggbh_input_2'] = $zbggbh_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['zbggbh_cond'] = $zbggbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['cgbbh'] = $cgbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['cgbbh_cond'] = $cgbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb']['where_pesq_ant'] = $this->comando . $this->comando_fim;
