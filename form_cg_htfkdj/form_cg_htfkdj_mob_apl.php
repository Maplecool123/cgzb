...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_cg_htfkdj_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("zh_cn");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_cg_htfkdj_mob']['upload_field_info']['fjfile'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cg_htfkdj_mob',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cg_htfkdj_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cg_htfkdj_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_htfkdj_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_htfkdj_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_cg_htfkdj_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_htfkdj_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_htfkdj'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_cg_htfkdj_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_cg_htfkdj_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['table_refresh'] = false;
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_field_ul_name'][$this->fjfile_ul_name]))
          {
              $this->NM_ajax_info['param']['fjfile_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_field_ul_name'][$this->fjfile_ul_name];
          }
      ...
      elseif (isset($this->fjfile_ul_name) && '' != $this->fjfile_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_field_ul_name'][$this->fjfile_ul_name]))
          {
              $this->fjfile_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_field_ul_name'][$this->fjfile_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_htfkdj_mob']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_cg_htfkdj/form_cg_htfkdj_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_cg_htfkdj_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_cg_htfkdj_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_cg_htfkdj_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_cg_htfkdj/form_cg_htfkdj_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_cg_htfkdj_mob_erro.class.php"); 
      }
      $this->Erro      = new form_cg_htfkdj_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_htfkdj_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_cg_htfkdj_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_cg_htfkdj_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_cg_htfkdj_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_cg_htfkdj_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_cg_htfkdj_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_cg_htfkdj_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_htbh(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['htbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['htbh'] == "on")) 
      { 
          if ($this->htbh == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['htmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['htmc'] == "on")) 
      { 
          if ($this->htmc == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['cgbbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['cgbbh'] == "on")) 
      { 
          if ($this->cgbbh == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['cgbmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['cgbmc'] == "on")) 
      { 
          if ($this->cgbmc == "")  
          { 
    ...
    function ValidateField_htje(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['htje']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['htje'] == "on") 
           { 
    ...
    function ValidateField_fkje(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->fkje, 4, 2, -0, 999999, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['fkje']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['fkje'] == "on") 
           { 
    ...
    function ValidateField_fkzb(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->fkzb, 4, 2, -0, 999999, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['fkzb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['fkzb'] == "on") 
           { 
    ...
    function ValidateField_fkjd(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->fkjd, 4, 2, -0, 999999, "N") == false)  
              { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['fkjd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['fkjd'] == "on") 
           { 
    ...
    {
        global $teste_validade;
      if ($this->fklx == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['fklx']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['php_cmp_required']['fklx'] == "on"))
      {
          ...
          if (!empty($this->fklx) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Lookup_fklx']) && !in_array($this->fklx, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Lookup_fklx']))
          {
    ...
    function ValidateField_fjfile(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                include_once 'form_cg_htfkdj_mob_doc_name.php';
            }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_cg_htfkdj_mob_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Lookup_fklx']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Lookup_fklx'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Lookup_fklx']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Lookup_fklx'] = array(); 
}
$aLookup[] = array(form_cg_htfkdj_mob_pack_protect_string('') => form_cg_htfkdj_mob_pack_protect_string('请选择'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Lookup_fklx'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY mc";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_cg_htfkdj_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_cg_htfkdj_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['Lookup_fklx'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fklx']['valList'][$i] = form_cg_htfkdj_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->dlr = $this->dlr_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['parms'] = "id?#?$this->id?@?"; 
      }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_filter_form'];
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sub_dir'][0]  = "htfk";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['reg_start'] < $qt_geral_reg_form_cg_htfkdj_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_select'];
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['dados_select'];
...
{
$_SESSION['scriptcase']['form_cg_htfkdj_mob']['contr_erro'] = 'on';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
    ...
    include_once("form_cg_htfkdj_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_cg_htfkdj_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['total'] = $qt_geral_reg_form_cg_htfkdj_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_cg_htfkdj_mob_pack_ajax_response();
      ...
      $Nm_datas['sjfkrq'] = "date";$Nm_datas['fkdjrq'] = "date";$Nm_datas['dlsj'] = "datetime";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_cg_htfkdj_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_cg_htfkdj_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htfkdj_mob']['masterValue'] as $cmp_master => $val_master)
{
?>
