<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_dzcp_tolist_byzjbh_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_dzcp_tolist_byzjbh_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cpbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["cpbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["cpbmc"] : "" . $this->Nm_lang['lang_eval_cpresult_fld_cpbmc'] . "";
   $tab_ger_campos['cgbmc'] = "on";
   $tab_def_campos['cgbmc'] = "cgbmc";
   $tab_converte["cgbmc"]   = "cgbmc";
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_eval_plan_fld_cgbmc'] . "";
   $tab_ger_campos['qymc'] = "on";
   $tab_def_campos['qymc'] = "qymc";
   $tab_converte["qymc"]   = "qymc";
   $tab_labels["qymc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["qymc"])) ? $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["qymc"] : "" . $this->Nm_lang['lang_eval_plan_fld_qymc'] . "";
   $tab_ger_campos['begintime'] = "on";
   $tab_def_campos['begintime'] = "begintime";
   $tab_converte["begintime"]   = "begintime";
   $tab_labels["begintime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["begintime"])) ? $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["begintime"] : "" . $this->Nm_lang['lang_eval_plan_fld_begintime'] . "";
   $tab_ger_campos['endtime'] = "on";
   $tab_def_campos['endtime'] = "endtime";
   $tab_converte["endtime"]   = "endtime";
   $tab_labels["endtime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["endtime"])) ? $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["endtime"] : "" . $this->Nm_lang['lang_eval_plan_fld_endtime'] . "";
   $tab_ger_campos['zjpb'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['zjpb'] = "zjpb";
       $tab_converte["zjpb"]   = "zjpb";
   }
   else
   {
       $tab_def_campos['zjpb'] = "";
   ...
   $tab_labels["zjpb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["zjpb"])) ? $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['labels']["zjpb"] : "操作";
   $tab_ger_campos['zjpb'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_menu_dzcp_tolist_byzjbh'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_dzcp_tolist_byzjbh_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_dzcp_tolist_byzjbh']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
