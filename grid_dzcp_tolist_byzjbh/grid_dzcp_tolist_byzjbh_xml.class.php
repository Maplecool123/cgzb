...
class grid_dzcp_tolist_byzjbh_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_dzcp_tolist_byzjbh_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_dzcp_tolist_byzjbh.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_dzcp_tolist_byzjbh";
...
$_SESSION['scriptcase']['grid_dzcp_tolist_byzjbh']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->zjpb))
         {
             $this->zjpb = sc_convert_encoding($this->zjpb, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " zjpb =\"" . $this->trata_dados($this->zjpb) . "\"";
   }
   //----- cpbbh
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_dzcp_tolist_byzjbh'] ?> :: XML</TITLE>
