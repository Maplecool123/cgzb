...
class grid_dzcp_tolist_byzjbh_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_dzcp_tolist_byzjbh_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_dzcp_tolist_byzjbh";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_dzcp_tolist_byzjbh.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "zjpb" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$_SESSION['scriptcase']['grid_dzcp_tolist_byzjbh']['contr_erro'] = 'off'; 
   ...
   //----- zjpb
   function NM_export_zjpb()
   {
         $this->zjpb = html_entity_decode($this->zjpb, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->zjpb = strip_tags($this->zjpb);
         if (!NM_is_utf8($this->zjpb))
         {
             $this->zjpb = sc_convert_encoding($this->zjpb, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->zjpb = str_replace('<', '&lt;', $this->zjpb);
         $this->zjpb = str_replace('>', '&gt;', $this->zjpb);
         $this->Texto_tag .= "<td>" . $this->zjpb . "</td>\r\n";
   }
   //----- cpbbh
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dzcp_tolist_byzjbh'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_dzcp_tolist_byzjbh'] ?> :: RTF</TITLE>
