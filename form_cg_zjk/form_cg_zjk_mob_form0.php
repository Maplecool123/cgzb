...
<?php
include_once("form_cg_zjk_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_zjk_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['recarga'];
}
?>
...
<?php
 include_once("form_cg_zjk_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_zjk_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_zjk_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zjbh_line" id="hidden_field_data_zjbh" style="<?php echo $sStyleHidden_zjbh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zjbh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_zjbh_label"><span id="id_label_zjbh"><?php echo $this->nm_new_label['zjbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['zjbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['zjbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_xb_line" id="hidden_field_data_xb" style="<?php echo $sStyleHidden_xb; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xb_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_xb_label"><span id="id_label_xb"><?php echo $this->nm_new_label['xb']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['xb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['xb'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['Lookup_xb'][] = '男'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['Lookup_xb'][] = '女'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sfzh_line" id="hidden_field_data_sfzh" style="<?php echo $sStyleHidden_sfzh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sfzh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sfzh_label"><span id="id_label_sfzh"><?php echo $this->nm_new_label['sfzh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['sfzh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['sfzh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gzdw_line" id="hidden_field_data_gzdw" style="<?php echo $sStyleHidden_gzdw; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gzdw_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gzdw_label"><span id="id_label_gzdw"><?php echo $this->nm_new_label['gzdw']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['gzdw']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['gzdw'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zy_line" id="hidden_field_data_zy" style="<?php echo $sStyleHidden_zy; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zy_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_zy_label"><span id="id_label_zy"><?php echo $this->nm_new_label['zy']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_work_line" id="hidden_field_data_work" style="<?php echo $sStyleHidden_work; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_work_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_work_label"><span id="id_label_work"><?php echo $this->nm_new_label['work']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zc_line" id="hidden_field_data_zc" style="<?php echo $sStyleHidden_zc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_zc_label"><span id="id_label_zc"><?php echo $this->nm_new_label['zc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_lwbz_line" id="hidden_field_data_lwbz" style="<?php echo $sStyleHidden_lwbz; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lwbz_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_lwbz_label"><span id="id_label_lwbz"><?php echo $this->nm_new_label['lwbz']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kyzt_line" id="hidden_field_data_kyzt" style="<?php echo $sStyleHidden_kyzt; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kyzt_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kyzt_label"><span id="id_label_kyzt"><?php echo $this->nm_new_label['kyzt']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['kyzt']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['php_cmp_required']['kyzt'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['Lookup_kyzt'][] = '是'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['Lookup_kyzt'][] = '否'; ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zjk_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_zjk_mob");
 parent.scAjaxDetailHeight("form_cg_zjk_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
