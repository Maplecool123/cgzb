...
<?php
include_once("form_cg_htgl_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_htgl_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['recarga'];
}
?>
...
<?php
 include_once("form_cg_htgl_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_htgl'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_htgl'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgbbh_label" id="hidden_field_label_cgbbh" style="<?php echo $sStyleHidden_cgbbh; ?>"><span id="id_label_cgbbh"><?php echo $this->nm_new_label['cgbbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgbbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgbbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_cgbbh" class="sc-ui-readonly-cgbbh css_cgbbh_line" style="<?php echo $sStyleReadLab_cgbbh; ?>"><?php echo $this->form_encode_input($this->cgbbh); ?></span><span id="id_read_off_cgbbh" style="white-space: nowrap;<?php echo $sStyleReadInp_cgbbh; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_cgb"]) && $this->Ini->sc_lig_md5["grid_cg_cgb"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,cgbbh,b_cgbbh*scoutnm_evt_ret_busca*scinsc_form_cg_htgl_cgbbh_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_htgl@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,cgbbh,b_cgbbh*scoutnm_evt_ret_busca*scinsc_form_cg_htgl_cgbbh_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgbmc_label" id="hidden_field_label_cgbmc" style="<?php echo $sStyleHidden_cgbmc; ?>"><span id="id_label_cgbmc"><?php echo $this->nm_new_label['cgbmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgbmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgbmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgybh_label" id="hidden_field_label_cgybh" style="<?php echo $sStyleHidden_cgybh; ?>"><span id="id_label_cgybh"><?php echo $this->nm_new_label['cgybh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgybh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgybh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cgybh_line" id="hidden_field_data_cgybh" style="<?php echo $sStyleHidden_cgybh; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgybh_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgyxm_label" id="hidden_field_label_cgyxm" style="<?php echo $sStyleHidden_cgyxm; ?>"><span id="id_label_cgyxm"><?php echo $this->nm_new_label['cgyxm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgyxm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgyxm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgylxdh_label" id="hidden_field_label_cgylxdh" style="<?php echo $sStyleHidden_cgylxdh; ?>"><span id="id_label_cgylxdh"><?php echo $this->nm_new_label['cgylxdh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgylxdh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgylxdh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cgylxdh_line" id="hidden_field_data_cgylxdh" style="<?php echo $sStyleHidden_cgylxdh; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgylxdh_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgfs_label" id="hidden_field_label_cgfs" style="<?php echo $sStyleHidden_cgfs; ?>"><span id="id_label_cgfs"><?php echo $this->nm_new_label['cgfs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgfs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['cgfs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_htmc_label" id="hidden_field_label_htmc" style="<?php echo $sStyleHidden_htmc; ?>"><span id="id_label_htmc"><?php echo $this->nm_new_label['htmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['htmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['htmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_htbh_label" id="hidden_field_label_htbh" style="<?php echo $sStyleHidden_htbh; ?>"><span id="id_label_htbh"><?php echo $this->nm_new_label['htbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['htbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['htbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_htlx_label" id="hidden_field_label_htlx" style="<?php echo $sStyleHidden_htlx; ?>"><span id="id_label_htlx"><?php echo $this->nm_new_label['htlx']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['htlx']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['htlx'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_htlx_line" id="hidden_field_data_htlx" style="<?php echo $sStyleHidden_htlx; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_htlx_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_htje_label" id="hidden_field_label_htje" style="<?php echo $sStyleHidden_htje; ?>"><span id="id_label_htje"><?php echo $this->nm_new_label['htje']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['htje']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['htje'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_qdrq_label" id="hidden_field_label_qdrq" style="<?php echo $sStyleHidden_qdrq; ?>"><span id="id_label_qdrq"><?php echo $this->nm_new_label['qdrq']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['qdrq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['qdrq'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_qdrq_line" id="hidden_field_data_qdrq" style="<?php echo $sStyleHidden_qdrq; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qdrq_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_qydw_label" id="hidden_field_label_qydw" style="<?php echo $sStyleHidden_qydw; ?>"><span id="id_label_qydw"><?php echo $this->nm_new_label['qydw']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['qydw']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['qydw'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_qydw_line" id="hidden_field_data_qydw" style="<?php echo $sStyleHidden_qydw; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qydw_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_qydw" class="sc-ui-readonly-qydw css_qydw_line" style="<?php echo $sStyleReadLab_qydw; ?>"><?php echo $this->form_encode_input($this->qydw); ?></span><span id="id_read_off_qydw" style="white-space: nowrap;<?php echo $sStyleReadInp_qydw; ?>">
 ...
 size=32 maxlength=64 alt="{datatype: 'text', maxLength: 64, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_company"]) && $this->Ini->sc_lig_md5["grid_cg_company"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,qydw,gsmc*scoutnm_evt_ret_busca*scinsc_form_cg_htgl_qydw_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_htgl@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,qydw,gsmc*scoutnm_evt_ret_busca*scinsc_form_cg_htgl_qydw_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_qydwlxr_label" id="hidden_field_label_qydwlxr" style="<?php echo $sStyleHidden_qydwlxr; ?>"><span id="id_label_qydwlxr"><?php echo $this->nm_new_label['qydwlxr']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['qydwlxr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['qydwlxr'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_qydwlxr_line" id="hidden_field_data_qydwlxr" style="<?php echo $sStyleHidden_qydwlxr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qydwlxr_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_qydwlxrdh_label" id="hidden_field_label_qydwlxrdh" style="<?php echo $sStyleHidden_qydwlxrdh; ?>"><span id="id_label_qydwlxrdh"><?php echo $this->nm_new_label['qydwlxrdh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['qydwlxrdh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['php_cmp_required']['qydwlxrdh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_qydwlxrdh_line" id="hidden_field_data_qydwlxrdh" style="<?php echo $sStyleHidden_qydwlxrdh; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qydwlxrdh_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zbj_label" id="hidden_field_label_zbj" style="<?php echo $sStyleHidden_zbj; ?>"><span id="id_label_zbj"><?php echo $this->nm_new_label['zbj']; ?></span></TD>
    <TD class="scFormDataOdd css_zbj_line" id="hidden_field_data_zbj" style="<?php echo $sStyleHidden_zbj; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zbj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zbdqrq_label" id="hidden_field_label_zbdqrq" style="<?php echo $sStyleHidden_zbdqrq; ?>"><span id="id_label_zbdqrq"><?php echo $this->nm_new_label['zbdqrq']; ?></span></TD>
    <TD class="scFormDataOdd css_zbdqrq_line" id="hidden_field_data_zbdqrq" style="<?php echo $sStyleHidden_zbdqrq; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zbdqrq_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_htgl']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_htgl");
 parent.scAjaxDetailHeight("form_cg_htgl", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
