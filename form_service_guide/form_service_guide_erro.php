...
$old_error_handler = set_error_handler("form_service_guide_scriptcase_error_handler");

function form_service_guide_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_service_guide']['contr_erro']) && $_SESSION['scriptcase']['form_service_guide']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_service_guide->contr_form_service_guide->Apl_com_erro = true;
            if ($inicial_form_service_guide->contr_form_service_guide->NM_ajax_flag)
            {
                $inicial_form_service_guide->contr_form_service_guide->NM_ajax_info['errList']['geral_form_service_guide'][] = $msg;
                return;
            }
            form_service_guide_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_service_guide_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_service_guide'])  && '' != $_SESSION['scriptcase']['error_icon']['form_service_guide'])  ? $_SESSION['scriptcase']['error_icon']['form_service_guide']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_service_guide']) && '' != $_SESSION['scriptcase']['error_span_title']['form_service_guide']) ? $_SESSION['scriptcase']['error_span_title']['form_service_guide'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_service_guide']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_service_guide']) ? $_SESSION['scriptcase']['error_icon_title']['form_service_guide'] : '';
?>
