  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_service_guide" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate name
  function do_ajax_form_service_guide_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_guide_validate_name(var_name, var_script_case_init, do_ajax_form_service_guide_validate_name_cb);
  } // do_ajax_form_service_guide_validate_name

  function do_ajax_form_service_guide_validate_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_guide_validate_name_cb

  // ---------- Validate summary
  function do_ajax_form_service_guide_validate_summary()
  {
    var nomeCampo_summary = "summary";
    var var_summary = scAjaxGetFieldEditorHtml(nomeCampo_summary);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_guide_validate_summary(var_summary, var_script_case_init, do_ajax_form_service_guide_validate_summary_cb);
  } // do_ajax_form_service_guide_validate_summary

  function do_ajax_form_service_guide_validate_summary_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "summary";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_guide_validate_summary_cb
  // ---------- Form
  function do_ajax_form_service_guide_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_service_guide_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_service_guide_submit_form(var_name, var_summary, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_service_guide_submit_form_cb);
  } // do_ajax_form_service_guide_submit_form

  function do_ajax_form_service_guide_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_service_guide_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_service_guide_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_service_guide_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_service_guide_navigate_form_cb);
  } // do_ajax_form_service_guide_navigate_form

  function do_ajax_form_service_guide_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_service_guide_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_service_guide_navigate_form_cb
  function sc_hide_form_service_guide_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_service_guide_form
